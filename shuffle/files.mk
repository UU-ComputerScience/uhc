...
# make rules
$(SHUFFLE_BLD_EXEC): $(SHUFFLE_AG_ALL_MAIN_DRV_HS) $(SHUFFLE_HS_MAIN_SRC_HS) $(SHUFFLE_HS_DPDS_SRC_HS) $(LIB_SRC_HS)
	mkdir -p $(@D)
#	$(GHC) --make $(GHC_OPTS) $(GHC_OPTS_OPTIM) -i$(LIB_SRC_PREFIX) -i$(SHUFFLE_SRC_PREFIX) $(SHUFFLE_SRC_PREFIX)$(SHUFFLE_MAIN).hs -o $@
	$(GHC) --make $(GHC_OPTS) -i$(LIB_SRC_PREFIX) -i$(SHUFFLE_SRC_PREFIX) -i$(SHUFFLE_BLD_PREFIX) $(SHUFFLE_SRC_PREFIX)$(SHUFFLE_MAIN).hs -o $@
	strip $@
