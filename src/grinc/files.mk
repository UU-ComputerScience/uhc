...
GRINC_AGGBCODE_PRETTYC_MAIN_SRC_CAG		:= $(patsubst %,$(SRC_GRINC_PREFIX)GrinByteCode/%.cag,PrettyC)
GRINC_AGGBCODE_PRETTYC_DPDS_SRC_CAG		:= $(patsubst %,$(SRC_GRINC_PREFIX)GrinByteCode/%.cag,AbsSyn)
$(patsubst $(SRC_GRINC_PREFIX)%.cag,$(GRINC_BLD_LIB_HS_VARIANT_PREFIX)%.hs,$(GRINC_AGGBCODE_PRETTYC_MAIN_SRC_CAG)) \
										: $(patsubst $(SRC_GRINC_PREFIX)%.cag,$(GRINC_BLD_LIB_HS_VARIANT_PREFIX)%.ag,$(GRINC_AGGBCODE_PRETTYC_DPDS_SRC_CAG))
...
GRINC_AG_S_MAIN_SRC_CAG					:= \
											...
											$(GRINC_AGGBCODE_PRETTYC_MAIN_SRC_CAG) \
...
GRINC_AG_ALL_DPDS_SRC_CAG				:= $(sort \
											...
											$(GRINC_AGGBCODE_PRETTYC_DPDS_SRC_CAG) \
