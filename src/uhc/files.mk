...
# location of uhc src
SRC_UHC_PREFIX							:= $(SRC_PREFIX)uhc/

# this file
UHC_MKF									:= $(SRC_UHC_PREFIX)files.mk

# main + sources + dpds, for .chs
UHC_HS_UTIL_SRC_CHS						:= $(patsubst %,$(SRC_UHC_PREFIX)%.chs,\
													HSParser \
											)
UHC_HS_UTIL_DRV_HS						:= $(patsubst $(SRC_UHC_PREFIX)%.chs,$(UHC_BLD_VARIANT_PREFIX)%.hs,$(UHC_HS_UTIL_SRC_CHS))
...
UHC_AGMAIN_MAIN_SRC_CAG					:= $(patsubst %,$(SRC_UHC_PREFIX)%.cag,HSMainAG)
UHC_AGMAIN_DPDS_SRC_CAG					:= $(patsubst %,$(SRC_UHC_PREFIX)%.cag,UHA_Syntax)
$(patsubst $(SRC_UHC_PREFIX)%.cag,$(UHC_BLD_VARIANT_PREFIX)%.hs,$(UHC_AGMAIN_MAIN_SRC_CAG)) \
										: $(patsubst $(SRC_UHC_PREFIX)%.cag,$(UHC_BLD_VARIANT_PREFIX)%.ag,$(UHC_AGMAIN_DPDS_SRC_CAG))

UHC_AGHSAST_MAIN_SRC_CAG				:= $(patsubst %,$(SRC_UHC_PREFIX)%.cag,HSAbsSyn)
UHC_AGHSAST_DPDS_SRC_CAG				:= $(patsubst %,$(SRC_UHC_PREFIX)%.cag,UHA_Syntax)
$(patsubst $(SRC_UHC_PREFIX)%.cag,$(UHC_BLD_VARIANT_PREFIX)%.hs,$(UHC_AGHSAST_MAIN_SRC_CAG)) \
										: $(patsubst $(SRC_UHC_PREFIX)%.cag,$(UHC_BLD_VARIANT_PREFIX)%.ag,$(UHC_AGHSAST_DPDS_SRC_CAG))
...
# derived
UHC_AG_D_MAIN_DRV_AG					:= $(patsubst $(SRC_UHC_PREFIX)%.cag,$(UHC_BLD_VARIANT_PREFIX)%.ag,$(UHC_AG_D_MAIN_SRC_CAG))
UHC_AG_S_MAIN_DRV_AG					:= $(patsubst $(SRC_UHC_PREFIX)%.cag,$(UHC_BLD_VARIANT_PREFIX)%.ag,$(UHC_AG_S_MAIN_SRC_CAG))
UHC_AG_DS_MAIN_DRV_AG					:= $(patsubst $(SRC_UHC_PREFIX)%.cag,$(UHC_BLD_VARIANT_PREFIX)%.ag,$(UHC_AG_DS_MAIN_SRC_CAG))
...
UHC_AG_ALL_DPDS_DRV_AG					:= $(patsubst $(SRC_UHC_PREFIX)%.cag,$(UHC_BLD_VARIANT_PREFIX)%.ag,$(UHC_AG_ALL_DPDS_SRC_CAG))
