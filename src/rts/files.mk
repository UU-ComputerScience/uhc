...
RTS_ALL_SRC					:= $(RTS_H_RTS_SRC_CH) $(RTS_C_RTS_SRC_CC) $(RTS_C_RTS_SRC_CC_NO_OPTIM)
...
$(INSABS_LIB_RTS): $(EXTLIBS_BGC_INS_FLAG) $(RTS_C_RTS_DRV_O) $(RTS_C_RTS_DRV_O_NO_OPTIM) $(RTS_H_RTS_INS_H) $(RTS_MKF)
	mkdir -p $(@D)
