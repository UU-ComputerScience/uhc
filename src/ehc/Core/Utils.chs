...
mkCExprSatSelCase :: RCEEnv -> Maybe HsName -> CExpr -> CTag -> HsName -> HsName -> Int -> CExpr
mkCExprSatSelCase env ne e ct n lbl off
  = mkCExprSatSelsCase env ne e ct [(n,lbl,off)] (CExpr_Var n)
%%]
...
mkCExprSatSelsCase :: RCEEnv -> Maybe HsName -> CExpr -> CTag -> [(HsName,HsName,Int)] -> CExpr -> CExpr
mkCExprSatSelsCase env ne e ct nmLblOffL sel
  =  mkCExprSelsCase' env ne e ct nmLblOffL' sel
  where nmLblOffL'
          = case ct of
              CTagRec      -> [ mk n l o | (n,l,o) <- nmLblOffL ]
              CTag _ _ _ a -> [ maybe (mk hsnWild hsnWild o) (\(n,l) -> mk n l o) $ Map.lookup o offMp | o <- [0..a-1] ]
                           where offMp = Map.fromList [ (o,(n,l)) | (n,l,o) <- nmLblOffL ]
        mk n l o = (n,l,CExpr_Int o)
%%]
