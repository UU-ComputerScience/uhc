...
EHC_HS_UTIL_SRC_CHS						:= $(patsubst %,$(SRC_EHC_PREFIX)%.chs,\
													...
													$(addprefix Base/,Pragma Binary Serialize GenC Opts Hashable Target BasicAnnot Common Builtin Builtin2 HsName Debug Trie CfgPP ForceEval LaTeX HtmlCommon Bits FileSearchLocation PackageDatabase ParseUtils) \
