...
EHC_HS_UTIL_SRC_CHS						:= $(patsubst %,$(SRC_EHC_PREFIX)%.chs,\
													Substitutable Gam Cnstr Pred Deriving Module Config BuiltinPrims \
...
EHC_BY_RULER_RULES_95					:= $(EHC_BY_RULER_RULES_12)
EHC_BY_RULER_RULES_96					:= $(EHC_BY_RULER_RULES_95)
EHC_BY_RULER_RULES_99					:= $(EHC_BY_RULER_RULES_96) e.iint e.double
