...
TEXT_SUBS_DRV_TEX			:= $(if $(TEXT_CFG_TEXT_INCLUDES_PREV_RULER_TEX),$(RULER_12_DRV_TEX) $(RULER_3_DRV_TEX) $(RULER_4_DRV_TEX)) \
								$(RULER2_RULES_DRV_TEX) \
...
TEXT_ALL_SRC				:= $(TEXT_EDIT_SRC) $(TEXT_SUBS_ASIS_SRC) $(TEXT_BIB1_SRC) $(TEXT_BIB2_SRC) $(TEXT_BIB3_SRC) $(TEXT_MKF)
...
$(TEXT_BIB_DRV): $(TEXT_BIB1_SRC) $(TEXT_BIB2_SRC) $(TEXT_BIB3_SRC)
	mkdir -p $(@D)
	cat $(TEXT_BIB1_SRC) > $@
	cat $(TEXT_BIB2_SRC) >> $@
	cat $(TEXT_BIB3_SRC) >> $@
...
$(TEXT_INCL_LIST_TEX): $(TEXT_ALL_MK_FILES)
	@(for f in $(sort $(notdir $(TEXT_SUBS_DRV_TEX) \
	                           $(if $(TEXT_CFG_TEXT_INCLUDES_PREV_RULER_TEX),$(TEXT_RULEX_ALL_DRV_TEX) $(TEXT_RULEUX_ALL_DRV_TEX) $(TEXT_RULEX_ALL_DRV_TEX) $(TEXT_RULER2_DEMO_ALL_DRV_TEX) $(TEXT_RULER2_DEMO_TEX)) \
	                           $(TEXT_INF2PS_ALL_DRV_TEX) \
	            )      ) ; \
	  do \
	    echo "\\input" $$f ; \
	  done \
