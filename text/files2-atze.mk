...
text-variant-icfp08-subst:
	$(MAKE) TEXT_CFG_SHUFFLE_INCLUDES_CHUNK_SRC_EXPERIMENTS_SUBST=yes TEXT_CFG_TEXT_INCLUDES_EXPERIMENTS_SUBST_RULER_TEX=yes TEXT_SHUFFLE_ORDER="1 < 2 < 3, 2 < 21, 1 < 26 < 36" \
