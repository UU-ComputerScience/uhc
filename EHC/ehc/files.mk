...
EHC_AGCORE_FVS_MAIN_SRC_CAG				:= $(patsubst %,$(EHC_SRC_PREFIX)%.cag,EHCoreFvS)
EHC_AGCORE_FVS_DPDS_SRC_CAG				:= $(patsubst %,$(EHC_SRC_PREFIX)%.cag,EHCoreAbsSyn EHCoreTrfCommonFv)
$(patsubst $(EHC_SRC_PREFIX)%.cag,$(EHC_BLD_VARIANT_PREFIX)%.hs,$(EHC_AGCORE_FVS_MAIN_SRC_CAG)) \
										: $(patsubst $(EHC_SRC_PREFIX)%.cag,$(EHC_BLD_VARIANT_PREFIX)%.ag,$(EHC_AGCORE_FVS_DPDS_SRC_CAG))
...
EHC_AGCORE_TRF_ETARED_MAIN_SRC_CAG		:= $(patsubst %,$(EHC_SRC_PREFIX)%.cag,EHCoreTrfEtaRed)
EHC_AGCORE_TRF_ETARED_DPDS_SRC_CAG		:= $(patsubst %,$(EHC_SRC_PREFIX)%.cag,EHCoreCommonLev EHCoreTrfCommonFv EHCoreAbsSyn)
$(patsubst $(EHC_SRC_PREFIX)%.cag,$(EHC_BLD_VARIANT_PREFIX)%.hs,$(EHC_AGCORE_TRF_ETARED_MAIN_SRC_CAG)) \
										: $(patsubst $(EHC_SRC_PREFIX)%.cag,$(EHC_BLD_VARIANT_PREFIX)%.ag,$(EHC_AGCORE_TRF_ETARED_DPDS_SRC_CAG))
...
EHC_AGCORE_TRF_INLLETALI_DPDS_SRC_CAG	:= $(patsubst %,$(EHC_SRC_PREFIX)%.cag,EHCoreAbsSyn EHCoreCommonLev)
