...
, 0x46,0x61,0x63,0x74,0x2e,0x75,0x35,0x5f,0x31,0x39,0x00
...
, {0,FunctionInfoFlag_None,&(Fact_bytePool[35])}
, {8,FunctionInfoFlag_None,&(Fact_bytePool[46])}
, {8,FunctionInfoFlag_None,&(Fact_bytePool[57])}
, {8,FunctionInfoFlag_None,&(Fact_bytePool[68])}
, {8,FunctionInfoFlag_None,&(Fact_bytePool[78])}
, {8,FunctionInfoFlag_None,&(Fact_bytePool[89])}
};
...
, MkCallInfoWith(0,&(Fact_bytePool[0]),3,164,NULL,NULL) 
...
,    0xe6,0x8d,0x03,0x00,0x00,0x01,0x00,0x00,0x00
...
,    0xe6,0x0d,0x00,0x00,0x00,0x05,0x00,0x00,0x00
,    0x08,0x01
,    0x20,0x10
,    0xfe,0x04,0x00,0x18,0x00
};
...
static GB_BytePtr* Fact_mainEntryPtr = &(Fact_globalEntries[6]) ;
