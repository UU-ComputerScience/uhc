...
{ 
...
{ {0,FunctionInfoFlag_None,&(Main_bytePool[0])}
, {8,FunctionInfoFlag_None,&(Main_bytePool[25])}
, {8,FunctionInfoFlag_None,&(Main_bytePool[32])}
, {8,FunctionInfoFlag_None,&(Main_bytePool[43])}
, {8,FunctionInfoFlag_None,&(Main_bytePool[50])}
, {16,FunctionInfoFlag_None,&(Main_bytePool[61])}
, {16,FunctionInfoFlag_None,&(Main_bytePool[85])}
, {16,FunctionInfoFlag_None,&(Main_bytePool[96])}
, {16,FunctionInfoFlag_None,&(Main_bytePool[139])}
, {16,FunctionInfoFlag_None,&(Main_bytePool[150])}
, {24,FunctionInfoFlag_None,&(Main_bytePool[161])}
, {8,FunctionInfoFlag_None,&(Main_bytePool[174])}
, {8,FunctionInfoFlag_None,&(Main_bytePool[184])}
, {8,FunctionInfoFlag_None,&(Main_bytePool[195])}
};
 
static CallInfo Main_callinfos[] =
{ MkCallInfoWith(11,&(Main_bytePool[8]),FunctionInfo_Inx_None,FunctionInfo_Inx_None,NULL,NULL) 
, MkCallInfoWith(2,&(Main_bytePool[68]),FunctionInfo_Inx_None,FunctionInfo_Inx_None,NULL,NULL) 
, MkCallInfoWith(0,&(Main_bytePool[0]),3,164,NULL,NULL) 
, MkCallInfoWith(2,&(Main_bytePool[50]),FunctionInfo_Inx_None,FunctionInfo_Inx_None,NULL,NULL) 
, MkCallInfoWith(2,&(Main_bytePool[103]),FunctionInfo_Inx_None,FunctionInfo_Inx_None,NULL,NULL) 
, MkCallInfoWith(2,&(Main_bytePool[120]),FunctionInfo_Inx_None,FunctionInfo_Inx_None,NULL,NULL) 
, MkCallInfoWith(2,&(Main_bytePool[32]),FunctionInfo_Inx_None,FunctionInfo_Inx_None,NULL,NULL) 
, MkCallInfoWith(0,&(Main_bytePool[0]),0,110,NULL,NULL) 
, MkCallInfoWith(0,&(Main_bytePool[0]),5,24,NULL,NULL) 
, MkCallInfoWith(0,&(Main_bytePool[0]),1,14,NULL,NULL) 
};
...
,    0x20,0x10
,    0xfe,0x02,0x00,0x08,0x19,0x02,0x00,0x00,0x00,0x00,0x00,0x00
...
,    0xa1,0x03,0x00,0x00,0x03,0x00,0x00,0x00
,    0x68,0x02
,    0xf4,0x00,0x08,0x00
...
,    0x20,0x10
,    0xe0,0x59,0x02,0x00,0x00,0x01,0x00,0x00,0x00
,    0xe7,0xe5,0x02,0x00,0x00,0x00,0x00,0x00,0x00
,    0x24,0x68
,    0xe7,0x25,0x03,0x00,0x00,0x03,0x00,0x00,0x00
,    0x25,0xc8,0x01
,    0xf0,0xd9,0x04,0x00,0x00,0x02,0x00,0x00,0x00
,    0x20,0x08
,    0x08,0x01
,    0x20,0x10
,    0xfe,0x04,0x00,0x18,0x08
,    0x61,0x02,0x00,0x00,0x06,0x00,0x00,0x00
,    0xe6,0x4d,0x02,0x00,0x00,0x04,0x00,0x00,0x00
,    0xe0,0x59,0x02,0x00,0x00,0x03,0x00,0x00,0x00
,    0xe7,0xe5,0x02,0x00,0x00,0x00,0x00,0x00,0x00
,    0x24,0x68
,    0xe7,0x25,0x03,0x00,0x00,0x03,0x00,0x00,0x00
,    0x25,0xc8,0x01
...
,    0x20,0x10
,    0xe0,0x59,0x02,0x00,0x00,0x04,0x00,0x00,0x00
,    0xe7,0x25,0x03,0x00,0x00,0x03,0x00,0x00,0x00
,    0x25,0x38,0x01
,    0xe0,0xd9,0x04,0x00,0x00,0x05,0x00,0x00,0x00
,    0x20,0x08
,    0x08,0x01
,    0x20,0x10
,    0xfe,0x04,0x00,0x18,0x08
...
,    0xe0,0x59,0x02,0x00,0x00,0x06,0x00,0x00,0x00
,    0xe7,0x25,0x03,0x00,0x00,0x03,0x00,0x00,0x00
,    0x25,0x38,0x01
,    0xe0,0xd9,0x04,0x00,0x00,0x05,0x00,0x00,0x00
,    0x20,0x08
...
,    0xe6,0x4d,0x04,0x00,0x00,0x08,0x00,0x00,0x00
,    0x08,0x02
,    0x20,0x18
...
,    0xe6,0x4d,0x02,0x00,0x00,0x0a,0x00,0x00,0x00
,    0xe7,0xe5,0x02,0x00,0x00,0x05,0x00,0x00,0x00
,    0x24,0x08
,    0xf0,0x59,0x02,0x00,0x00,0x08,0x00,0x00,0x00
,    0xe6,0x4d,0x04,0x00,0x00,0x09,0x00,0x00,0x00
,    0x08,0x01
,    0x20,0x10
,    0xfe,0x04,0x00,0x18,0x00
...
,    0xe6,0x4d,0x02,0x00,0x00,0x0b,0x00,0x00,0x00
,    0xe7,0xe5,0x02,0x00,0x00,0x01,0x00,0x00,0x00
,    0x24,0x08
,    0xf0,0x59,0x02,0x00,0x00,0x09,0x00,0x00,0x00
,    0xe6,0x0d,0x00,0x00,0x00,0x0c,0x00,0x00,0x00
,    0x08,0x01
,    0x20,0x10
,    0xfe,0x04,0x00,0x18,0x00
};
...
static GB_BytePtr* Main_mainEntryPtr = &(Main_globalEntries[13]) ;
...
int main(int argc, char** argv) {
  ...
  UHC_BaseZero_initModule(Main_moduleEntries,0) ;
  UHC_BaseOne_initModule(Main_moduleEntries,1) ;
  UHC_BaseTwo_initModule(Main_moduleEntries,2) ;
  UHC_BaseThree_initModule(Main_moduleEntries,3) ;
  UHC_BaseFour_initModule(Main_moduleEntries,4) ;
  UHC_BaseFive_initModule(Main_moduleEntries,5) ;
  UHC_Base_initModule(Main_moduleEntries,6) ;
  UHC_StackTrace_initModule(Main_moduleEntries,7) ;
  UHC_Enum_initModule(Main_moduleEntries,8) ;
  UHC_MutVar_initModule(Main_moduleEntries,9) ;
  UHC_Read_initModule(Main_moduleEntries,10) ;
  UHC_Real_initModule(Main_moduleEntries,11) ;
  UHC_ST_initModule(Main_moduleEntries,12) ;
  UHC_Generics_Tuple_initModule(Main_moduleEntries,13) ;
  UHC_Generics_initModule(Main_moduleEntries,14) ;
  UHC_Eq_initModule(Main_moduleEntries,15) ;
  UHC_Ord_initModule(Main_moduleEntries,16) ;
  UHC_Bits_initModule(Main_moduleEntries,17) ;
  Data_Maybe_initModule(Main_moduleEntries,18) ;
  Unsafe_Coerce_initModule(Main_moduleEntries,19) ;
  UHC_Types_initModule(Main_moduleEntries,20) ;
  UHC_Prims_initModule(Main_moduleEntries,21) ;
  Data_Bits_initModule(Main_moduleEntries,22) ;
  UHC_Bounded_initModule(Main_moduleEntries,23) ;
  UHC_Char_initModule(Main_moduleEntries,24) ;
  UHC_STRef_initModule(Main_moduleEntries,25) ;
  UHC_Float_initModule(Main_moduleEntries,26) ;
  UHC_Show_initModule(Main_moduleEntries,27) ;
  UHC_Int_initModule(Main_moduleEntries,28) ;
  Data_Char_initModule(Main_moduleEntries,29) ;
  Data_List_initModule(Main_moduleEntries,30) ;
  Data_Either_initModule(Main_moduleEntries,31) ;
  UHC_Ptr_initModule(Main_moduleEntries,32) ;
  UHC_WeakPtr_initModule(Main_moduleEntries,33) ;
  UHC_StablePtr_initModule(Main_moduleEntries,34) ;
  Foreign_StablePtr_initModule(Main_moduleEntries,35) ;
  UHC_Storable_initModule(Main_moduleEntries,36) ;
  UHC_ByteArray_initModule(Main_moduleEntries,37) ;
  UHC_IOBase_initModule(Main_moduleEntries,38) ;
  UHC_OldException_initModule(Main_moduleEntries,39) ;
  Data_IORef_initModule(Main_moduleEntries,40) ;
  UHC_Word_initModule(Main_moduleEntries,41) ;
  Data_Word_initModule(Main_moduleEntries,42) ;
  Control_Monad_initModule(Main_moduleEntries,43) ;
  System_IO_Unsafe_initModule(Main_moduleEntries,44) ;
  Data_Int_initModule(Main_moduleEntries,45) ;
  Data_Typeable_initModule(Main_moduleEntries,46) ;
  UHC_Weak_initModule(Main_moduleEntries,47) ;
  UHC_MVar_initModule(Main_moduleEntries,48) ;
  Foreign_Storable_initModule(Main_moduleEntries,49) ;
  Foreign_C_TypesZero_initModule(Main_moduleEntries,50) ;
  Foreign_C_Types_initModule(Main_moduleEntries,51) ;
  Foreign_Ptr_initModule(Main_moduleEntries,52) ;
  Foreign_Marshal_Error_initModule(Main_moduleEntries,53) ;
  UHC_ForeignPtr_initModule(Main_moduleEntries,54) ;
  Foreign_ForeignPtr_initModule(Main_moduleEntries,55) ;
  Foreign_Marshal_Alloc_initModule(Main_moduleEntries,56) ;
  Foreign_Marshal_Utils_initModule(Main_moduleEntries,57) ;
  Foreign_Marshal_Array_initModule(Main_moduleEntries,58) ;
  Foreign_C_String_initModule(Main_moduleEntries,59) ;
  Foreign_C_Error_initModule(Main_moduleEntries,60) ;
  Foreign_C_initModule(Main_moduleEntries,61) ;
  Foreign_Marshal_Pool_initModule(Main_moduleEntries,62) ;
  Foreign_Marshal_initModule(Main_moduleEntries,63) ;
  Foreign_initModule(Main_moduleEntries,64) ;
  System_Posix_Types_initModule(Main_moduleEntries,65) ;
  UHC_Conc_initModule(Main_moduleEntries,66) ;
  System_Posix_Internals_initModule(Main_moduleEntries,67) ;
  System_IO_Error_initModule(Main_moduleEntries,68) ;
  UHC_Handle_initModule(Main_moduleEntries,69) ;
  UHC_IO_initModule(Main_moduleEntries,70) ;
  System_IO_Fix_initModule(Main_moduleEntries,71) ;
  System_IO_initModule(Main_moduleEntries,72) ;
  UHC_Run_initModule(Main_moduleEntries,73) ;
  Prelude_initModule(Main_moduleEntries,74) ;
  Main_initModule(Main_moduleEntries,75) ;
  gb_SetModTable(Main_moduleEntries,76) ;
