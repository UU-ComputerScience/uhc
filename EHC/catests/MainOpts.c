...
static Word8 MainOpts_bytePool[] =
{ 
};
 
static GB_LinkChainResolvedInfo MainOpts_linkChainIndirections[] =
{};
 
static GCStackInfo MainOpts_gcStackInfos[] =
{ { 4
  , 2
  , &(MainOpts_bytePool[30])
  }
, { 3
  , 2
  , &(MainOpts_bytePool[43])
  }
, { 5
  , 2
  , &(MainOpts_bytePool[56])
  }
};
 
static FunctionInfo MainOpts_functionInfos[] =
{ {8,FunctionInfoFlag_None,&(MainOpts_bytePool[0])}
, {24,FunctionInfoFlag_None,&(MainOpts_bytePool[15])}
, {16,FunctionInfoFlag_None,&(MainOpts_bytePool[32])}
, {32,FunctionInfoFlag_None,&(MainOpts_bytePool[45])}
, {8,FunctionInfoFlag_None,&(MainOpts_bytePool[58])}
, {8,FunctionInfoFlag_None,&(MainOpts_bytePool[109])}
, {8,FunctionInfoFlag_None,&(MainOpts_bytePool[123])}
};
 
static CallInfo MainOpts_callinfos[] =
{ MkCallInfoWith(2,&(MainOpts_bytePool[45]),FunctionInfo_Inx_None,FunctionInfo_Inx_None,NULL,NULL) 
, MkCallInfoWith(11,&(MainOpts_bytePool[73]),FunctionInfo_Inx_None,FunctionInfo_Inx_None,NULL,NULL) 
, MkCallInfoWith(0,&(MainOpts_bytePool[0]),4,24,NULL,NULL) 
, MkCallInfoWith(0,&(MainOpts_bytePool[0]),1,14,NULL,NULL) 
};
 
static GB_Byte MainOpts_bytecode[] =
{    0xfe,0xff
...
,    0xe7,0x25,0x03,0x00,0x00,0x04,0x00,0x00,0x00
,    0x25,0x98,0x01
,    0xe7,0x25,0x03,0x00,0x00,0x04,0x00,0x00,0x00
,    0x25,0x50,0x03
...
,    0x08,0x20
,    0xec,0x85,0x05,0x00,0x00,0x03,0x00,0x00,0x00
,    0x20,0x00
,    0x0b,0x00,0x00,0x00,0x00,0x02,0x00,0x00,0x00
,    0x08,0x10
,    0xec,0x05,0x03,0x00,0x00,0x01,0x00,0x00,0x00
...
,    0xe0,0x19,0x04,0x00,0x00,0x00,0x00,0x00,0x00
,    0x20,0x00
,    0x40,0x08
,    0xfe,0x02,0x00,0x00,0x19,0x02,0x00,0x00,0x01,0x00,0x00,0x00
,    0x61,0x02,0x00,0x00,0x05,0x00,0x00,0x00
,    0xe6,0x4d,0x02,0x00,0x00,0x01,0x00,0x00,0x00
,    0xe7,0xe5,0x02,0x00,0x00,0x04,0x00,0x00,0x00
,    0x24,0x08
,    0xf0,0x59,0x02,0x00,0x00,0x02,0x00,0x00,0x00
...
,    0x24,0x08
,    0xf0,0x59,0x02,0x00,0x00,0x03,0x00,0x00,0x00
,    0xe6,0x0d,0x00,0x00,0x00,0x00,0x00,0x00,0x00
,    0x08,0x01
,    0x20,0x10
,    0xfe,0x04,0x00,0x18,0x00
};
GB_ByteCodeModule MainOpts_bytecodeModule =
  { "MainOpts"
  , NULL
  , 0
  , MainOpts_bytecode
...
static GB_Word MainOpts_constants[] =
{};
 
static HalfWord MainOpts_cafGlEntryIndices[] =
{ 0
, 1
, 3
, 4
...
static GB_BytePtr MainOpts_globalEntries[] =
{ &(MainOpts_bytecode[10])
, &(MainOpts_bytecode[24])
, &(MainOpts_bytecode[79])
, &(MainOpts_bytecode[113])
, &(MainOpts_bytecode[202])
, &(MainOpts_bytecode[244])
, &(MainOpts_bytecode[299])
};
GB_NodePtr MainOpts_expNode ;
static int MainOpts_expNode_offs[] =
  {} ;
int MainOpts_expNode_size = 0 ;

static GB_ImpModEntry MainOpts_impMods[] =
         { { "UHC.BaseFive"
           , 0 
           }
         , { "UHC.Run"
...
void MainOpts_initModule(GB_ModEntry* modTbl, Word modTblInx) {
  gb_InitTables( MainOpts_bytecode
               , 346
               , MainOpts_cafGlEntryIndices
               , 6
               , MainOpts_globalEntries
               , 7
               , MainOpts_constants
               , MainOpts_gcStackInfos
               , MainOpts_linkChainIndirections
               , MainOpts_callinfos
               , 4
               , MainOpts_functionInfos
               , 7
               , MainOpts_bytePool
               , 2
               , MainOpts_impMods
               , 5
               , &(MainOpts_expNode)
               , MainOpts_expNode_size
               , MainOpts_expNode_offs
               , modTbl
               , modTblInx
               ) ;
}

static GB_BytePtr* MainOpts_mainEntryPtr = &(MainOpts_globalEntries[6]) ;
...
extern void MainOpts_initModule(GB_ModEntry*,Word) ;
extern GB_NodePtr MainOpts_expNode ;
extern int MainOpts_expNode_size ;
extern GB_ByteCodeModule MainOpts_bytecodeModule ;
static GB_ModEntry MainOpts_moduleEntries[] =
         { { "UHC.BaseZero"
...
int main(int argc, char** argv) {
  ...
  GB_MkExpNodeIn( MainOpts_expNode, MainOpts_expNode_size ) ;
  UHC_BaseZero_initModule(MainOpts_moduleEntries,0) ;
  UHC_BaseOne_initModule(MainOpts_moduleEntries,1) ;
  UHC_BaseTwo_initModule(MainOpts_moduleEntries,2) ;
  UHC_BaseThree_initModule(MainOpts_moduleEntries,3) ;
  UHC_BaseFour_initModule(MainOpts_moduleEntries,4) ;
  UHC_BaseFive_initModule(MainOpts_moduleEntries,5) ;
  UHC_Base_initModule(MainOpts_moduleEntries,6) ;
  UHC_StackTrace_initModule(MainOpts_moduleEntries,7) ;
  UHC_Enum_initModule(MainOpts_moduleEntries,8) ;
  UHC_MutVar_initModule(MainOpts_moduleEntries,9) ;
  UHC_Read_initModule(MainOpts_moduleEntries,10) ;
  UHC_Real_initModule(MainOpts_moduleEntries,11) ;
  UHC_ST_initModule(MainOpts_moduleEntries,12) ;
  UHC_Generics_Tuple_initModule(MainOpts_moduleEntries,13) ;
  UHC_Generics_initModule(MainOpts_moduleEntries,14) ;
  UHC_Eq_initModule(MainOpts_moduleEntries,15) ;
  UHC_Ord_initModule(MainOpts_moduleEntries,16) ;
  UHC_Bits_initModule(MainOpts_moduleEntries,17) ;
  Data_Maybe_initModule(MainOpts_moduleEntries,18) ;
  Unsafe_Coerce_initModule(MainOpts_moduleEntries,19) ;
  UHC_Types_initModule(MainOpts_moduleEntries,20) ;
  UHC_Prims_initModule(MainOpts_moduleEntries,21) ;
  Data_Bits_initModule(MainOpts_moduleEntries,22) ;
  UHC_Bounded_initModule(MainOpts_moduleEntries,23) ;
  UHC_Char_initModule(MainOpts_moduleEntries,24) ;
  UHC_STRef_initModule(MainOpts_moduleEntries,25) ;
  UHC_Float_initModule(MainOpts_moduleEntries,26) ;
  UHC_Show_initModule(MainOpts_moduleEntries,27) ;
  UHC_Int_initModule(MainOpts_moduleEntries,28) ;
  Data_Char_initModule(MainOpts_moduleEntries,29) ;
  Data_List_initModule(MainOpts_moduleEntries,30) ;
  Data_Either_initModule(MainOpts_moduleEntries,31) ;
  UHC_Ptr_initModule(MainOpts_moduleEntries,32) ;
  UHC_WeakPtr_initModule(MainOpts_moduleEntries,33) ;
  UHC_StablePtr_initModule(MainOpts_moduleEntries,34) ;
  Foreign_StablePtr_initModule(MainOpts_moduleEntries,35) ;
  UHC_Storable_initModule(MainOpts_moduleEntries,36) ;
  UHC_ByteArray_initModule(MainOpts_moduleEntries,37) ;
  UHC_IOBase_initModule(MainOpts_moduleEntries,38) ;
  UHC_OldException_initModule(MainOpts_moduleEntries,39) ;
  Data_IORef_initModule(MainOpts_moduleEntries,40) ;
  UHC_Word_initModule(MainOpts_moduleEntries,41) ;
  Data_Word_initModule(MainOpts_moduleEntries,42) ;
  Control_Monad_initModule(MainOpts_moduleEntries,43) ;
  System_IO_Unsafe_initModule(MainOpts_moduleEntries,44) ;
  Data_Int_initModule(MainOpts_moduleEntries,45) ;
  Data_Typeable_initModule(MainOpts_moduleEntries,46) ;
  UHC_Weak_initModule(MainOpts_moduleEntries,47) ;
  UHC_MVar_initModule(MainOpts_moduleEntries,48) ;
  Foreign_Storable_initModule(MainOpts_moduleEntries,49) ;
  Foreign_C_TypesZero_initModule(MainOpts_moduleEntries,50) ;
  Foreign_C_Types_initModule(MainOpts_moduleEntries,51) ;
  Foreign_Ptr_initModule(MainOpts_moduleEntries,52) ;
  Foreign_Marshal_Error_initModule(MainOpts_moduleEntries,53) ;
  UHC_ForeignPtr_initModule(MainOpts_moduleEntries,54) ;
  Foreign_ForeignPtr_initModule(MainOpts_moduleEntries,55) ;
  Foreign_Marshal_Alloc_initModule(MainOpts_moduleEntries,56) ;
  Foreign_Marshal_Utils_initModule(MainOpts_moduleEntries,57) ;
  Foreign_Marshal_Array_initModule(MainOpts_moduleEntries,58) ;
  Foreign_C_String_initModule(MainOpts_moduleEntries,59) ;
  Foreign_C_Error_initModule(MainOpts_moduleEntries,60) ;
  Foreign_C_initModule(MainOpts_moduleEntries,61) ;
  Foreign_Marshal_Pool_initModule(MainOpts_moduleEntries,62) ;
  Foreign_Marshal_initModule(MainOpts_moduleEntries,63) ;
  Foreign_initModule(MainOpts_moduleEntries,64) ;
  System_Posix_Types_initModule(MainOpts_moduleEntries,65) ;
  UHC_Conc_initModule(MainOpts_moduleEntries,66) ;
  System_Posix_Internals_initModule(MainOpts_moduleEntries,67) ;
  System_IO_Error_initModule(MainOpts_moduleEntries,68) ;
  UHC_Handle_initModule(MainOpts_moduleEntries,69) ;
  UHC_IO_initModule(MainOpts_moduleEntries,70) ;
  System_IO_Fix_initModule(MainOpts_moduleEntries,71) ;
  System_IO_initModule(MainOpts_moduleEntries,72) ;
  UHC_Run_initModule(MainOpts_moduleEntries,73) ;
  Prelude_initModule(MainOpts_moduleEntries,74) ;
  MainOpts_initModule(MainOpts_moduleEntries,75) ;
  gb_SetModTable(MainOpts_moduleEntries,76) ;
  main_GB_Run( argc, argv, gb_code_Eval, Cast(GB_Word,*MainOpts_mainEntryPtr) ) ;
