...
{ 0x54,0x65,0x73,0x74,0x2e,0x75,0x35,0x5f,0x31,0x30,0x00
, 0x31,0x30,0x30,0x30,0x30,0x30,0x30,0x30,0x30,0x30,0x30,0x00
, 0x03,0x04
, 0x54,0x65,0x73,0x74,0x2e,0x75,0x35,0x5f,0x31,0x34,0x00
, 0x54,0x65,0x73,0x74,0x2e,0x75,0x35,0x5f,0x39,0x00
, 0x54,0x65,0x73,0x74,0x2e,0x75,0x35,0x5f,0x36,0x00
, 0x54,0x65,0x73,0x74,0x2e,0x75,0x33,0x5f,0x33,0x30,0x5f,0x31,0x5f,0x30,0x00
, 0x54,0x65,0x73,0x74,0x2e,0x75,0x35,0x5f,0x35,0x00
, 0x05,0x04
, 0x54,0x65,0x73,0x74,0x2e,0x6d,0x61,0x69,0x6e,0x00
...
{ {16,FunctionInfoFlag_None,&(Test_bytePool[0])}
, {8,FunctionInfoFlag_None,&(Test_bytePool[25])}
, {0,FunctionInfoFlag_None,&(Test_bytePool[36])}
, {16,FunctionInfoFlag_None,&(Test_bytePool[46])}
, {0,FunctionInfoFlag_None,&(Test_bytePool[56])}
, {24,FunctionInfoFlag_None,&(Test_bytePool[71])}
, {8,FunctionInfoFlag_None,&(Test_bytePool[83])}
, {8,FunctionInfoFlag_None,&(Test_bytePool[93])}
};
 
static CallInfo Test_callinfos[] =
{ MkCallInfoWith(0,&(Test_bytePool[0]),3,539,NULL,NULL) 
, MkCallInfoWith(0,&(Test_bytePool[0]),3,75,NULL,NULL) 
, MkCallInfoWith(0,&(Test_bytePool[0]),0,14,NULL,NULL) 
};
 
static GB_Byte Test_bytecode[] =
{    0xfe,0xff
,    0x61,0x02,0x00,0x00,0x00,0x00,0x00,0x00
,    0x0b,0x1d,0x05,0x00,0x00,0x0b,0x00,0x00,0x00
...
,    0x68,0x00
,    0xf4,0x00,0x08,0x00
,    0xe1,0x02,0x00,0x00,0x02,0x00,0x00,0x00
,    0x68,0x01
,    0xe7,0x25,0x04,0x00,0x00,0x03,0x00,0x00,0x00
,    0x25,0x90,0x0c
,    0xfe,0x00,0x00,0x08,0x00
...
,    0xe7,0x25,0x03,0x00,0x00,0x03,0x00,0x00,0x00
,    0x25,0xc8,0x09
,    0xf0,0x59,0x02,0x00,0x00,0x00,0x00,0x00,0x00
,    0xe6,0x4d,0x02,0x00,0x00,0x00,0x00,0x00,0x00
,    0xe6,0x4d,0x04,0x00,0x00,0x02,0x00,0x00,0x00
,    0x08,0x02
,    0x20,0x18
...
,    0xe7,0xa5,0x05,0x00,0x00,0x02,0x00,0x00,0x00
,    0x24,0x58
...
,    0xe6,0x4d,0x04,0x00,0x00,0x03,0x00,0x00,0x00
,    0x08,0x01
,    0x20,0x10
...
,    0xe6,0x0d,0x00,0x00,0x00,0x01,0x00,0x00,0x00
,    0x08,0x01
,    0x20,0x10
,    0xfe,0x04,0x00,0x18,0x00
};
...
static GB_BytePtr* Test_mainEntryPtr = &(Test_globalEntries[7]) ;
...
static GB_ModEntry Test_moduleEntries[] =
         { { "UHC.Base"
           , &(UHC_Base_expNode)
...
int main(int argc, char** argv) {
  ...
  UHC_Base_initModule(Test_moduleEntries,0) ;
  UHC_Bits_initModule(Test_moduleEntries,1) ;
  Data_Maybe_initModule(Test_moduleEntries,2) ;
  Unsafe_Coerce_initModule(Test_moduleEntries,3) ;
  UHC_Types_initModule(Test_moduleEntries,4) ;
  UHC_Char_initModule(Test_moduleEntries,5) ;
  UHC_Generics_Tuple_initModule(Test_moduleEntries,6) ;
  UHC_ST_initModule(Test_moduleEntries,7) ;
  UHC_Prims_initModule(Test_moduleEntries,8) ;
  UHC_Real_initModule(Test_moduleEntries,9) ;
  Data_Bits_initModule(Test_moduleEntries,10) ;
  UHC_Read_initModule(Test_moduleEntries,11) ;
  UHC_Generics_initModule(Test_moduleEntries,12) ;
  UHC_Bounded_initModule(Test_moduleEntries,13) ;
  UHC_MutVar_initModule(Test_moduleEntries,14) ;
  UHC_STRef_initModule(Test_moduleEntries,15) ;
  UHC_Enum_initModule(Test_moduleEntries,16) ;
  UHC_Float_initModule(Test_moduleEntries,17) ;
  UHC_Show_initModule(Test_moduleEntries,18) ;
  UHC_Int_initModule(Test_moduleEntries,19) ;
  UHC_Word_initModule(Test_moduleEntries,20) ;
  Data_Char_initModule(Test_moduleEntries,21) ;
  Data_List_initModule(Test_moduleEntries,22) ;
  Data_Either_initModule(Test_moduleEntries,23) ;
  UHC_Ptr_initModule(Test_moduleEntries,24) ;
  UHC_WeakPtr_initModule(Test_moduleEntries,25) ;
  UHC_StablePtr_initModule(Test_moduleEntries,26) ;
  Foreign_StablePtr_initModule(Test_moduleEntries,27) ;
  UHC_Storable_initModule(Test_moduleEntries,28) ;
  UHC_ByteArray_initModule(Test_moduleEntries,29) ;
  UHC_StackTrace_initModule(Test_moduleEntries,30) ;
  UHC_IOBase_initModule(Test_moduleEntries,31) ;
  UHC_OldException_initModule(Test_moduleEntries,32) ;
  Data_IORef_initModule(Test_moduleEntries,33) ;
  UHC_Eq_initModule(Test_moduleEntries,34) ;
  UHC_Ord_initModule(Test_moduleEntries,35) ;
  Data_Word_initModule(Test_moduleEntries,36) ;
  Control_Monad_initModule(Test_moduleEntries,37) ;
  System_IO_Unsafe_initModule(Test_moduleEntries,38) ;
  Data_Int_initModule(Test_moduleEntries,39) ;
  Data_Typeable_initModule(Test_moduleEntries,40) ;
  UHC_Weak_initModule(Test_moduleEntries,41) ;
  UHC_MVar_initModule(Test_moduleEntries,42) ;
  Foreign_Storable_initModule(Test_moduleEntries,43) ;
  Foreign_C_Types_initModule(Test_moduleEntries,44) ;
  Foreign_Ptr_initModule(Test_moduleEntries,45) ;
  Foreign_Marshal_Error_initModule(Test_moduleEntries,46) ;
  UHC_ForeignPtr_initModule(Test_moduleEntries,47) ;
  Foreign_ForeignPtr_initModule(Test_moduleEntries,48) ;
  Foreign_Marshal_Alloc_initModule(Test_moduleEntries,49) ;
  Foreign_Marshal_Utils_initModule(Test_moduleEntries,50) ;
  Foreign_Marshal_Array_initModule(Test_moduleEntries,51) ;
  Foreign_C_String_initModule(Test_moduleEntries,52) ;
  Foreign_C_Error_initModule(Test_moduleEntries,53) ;
  Foreign_C_initModule(Test_moduleEntries,54) ;
  Foreign_Marshal_Pool_initModule(Test_moduleEntries,55) ;
  Foreign_Marshal_initModule(Test_moduleEntries,56) ;
  Foreign_initModule(Test_moduleEntries,57) ;
  System_Posix_Types_initModule(Test_moduleEntries,58) ;
  UHC_Conc_initModule(Test_moduleEntries,59) ;
  System_Posix_Internals_initModule(Test_moduleEntries,60) ;
  System_IO_Error_initModule(Test_moduleEntries,61) ;
  UHC_Handle_initModule(Test_moduleEntries,62) ;
  UHC_IO_initModule(Test_moduleEntries,63) ;
  System_IO_Fix_initModule(Test_moduleEntries,64) ;
  System_IO_initModule(Test_moduleEntries,65) ;
  UHC_Run_initModule(Test_moduleEntries,66) ;
  Prelude_initModule(Test_moduleEntries,67) ;
  Test_initModule(Test_moduleEntries,68) ;
  gb_SetModTable(Test_moduleEntries,69) ;
  main_GB_Run( argc, argv, gb_code_Eval, Cast(GB_Word,*Test_mainEntryPtr) ) ;
