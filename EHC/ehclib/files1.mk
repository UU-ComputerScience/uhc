...
EHCLIB_EHCUHCBASE_PREFIX				:= $(EHCLIB_EHCUHCBASE)/
EHCLIB_EHCLIB_EHCUHCBASE				:= $(EHCLIB_EHCLIB_PREFIX)$(EHCLIB_EHCUHCBASE)
...
# install locations
EHCLIB_INS_LIB_PREFIX					:= $(call FUN_DIR_VARIANT_LIB_PREFIX,$(INSTALL_DIR),$(EHC_VARIANT))
EHCLIB_INS_LIB_DIR						:= $(call FUN_PREFIX2DIR,$(EHCLIB_INS_LIB_PREFIX))
...
EHCLIB_ASIS_RTS_SRC_ASIS				:= $(addprefix $(EHCLIB_UHCBASE_INC_SRC_PREFIX),MachDeps.h HsBase.h HsBaseConfig.h)
