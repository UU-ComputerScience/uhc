...
TEXT_ALL_PDFONLY_DPD		:= $(TEXT_MAIN_DRV_TEX) $(TEXT_SUBS_DRV_TEX) $(TEXT_MAIN_DRV_STY) $(TEXT_INF2PS_ALL_DRV_TEX) $(TEXT_RULEX_ALL_DRV_TEX) \
								$(TEXT_SUBS_ASIS_DRV) $(FIGS_XFIG_DRV_TEX) $(FIGS_XFIG_DRV_PDF) $(FIGS_EPS_DRV_PDF) $(FIGS_DOT_DRV_PDF) $(FIGS_ASIS_DRV) $(TEXT_HIDE_DRV_TEX)  \
...
$(TEXT_INCL_LIST_TEX): $(TEXT_ALL_MK_FILES)
	@(for f in $(sort $(notdir $(TEXT_SUBS_DRV_TEX) \
	                           ...
	                           $(TEXT_INF2PS_ALL_DRV_TEX) $(RULER_4_DRV_TEX) $(RULER_3_DRV_TEX) $(TEXT_RULEUX_ALL_DRV_TEX) $(TEXT_RULEX_ALL_DRV_TEX) \
	            )      ) ; \
	  do \
	    echo "\\input" $$f ; \
	  done \
...
#omitted (because ruler has its own repo etc): $(TEXT_RULER2_DEMO_ALL_DRV_TEX) $(TEXT_RULER2_DEMO_TEX)
