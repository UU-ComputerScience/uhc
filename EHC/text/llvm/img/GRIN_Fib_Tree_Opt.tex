...
\node [payload, text width=5em] (FprimSubIntLeft-Load2) at (FprimSubIntLeft-Load1.east) {$\$global\_p22$};
...
\node [payload, text width=5em] (FprimSubIntRight-Load2) at (FprimSubIntRight-Load1.east) {$\$global\_p25$};
