...
GRINC_AGGRINCODE_TOGBCODE_DPDS_SRC_CAG	:= $(patsubst %,$(SRC_GRINC_PREFIX)GrinCode/%.cag,TrfLocal/CommonFreeVar TrfLocal/CommonAliasAG)
...
GRINC_AGGRINCODE_FREEVARS_DPDS_SRC_CAG	:= $(patsubst %,$(SRC_GRINC_PREFIX)GrinCode/%.cag,TrfLocal/CommonFreeVar TrfLocal/CommonAliasAG)
...
GRINC_AGGRINCODE_ALLTRF_MAIN_SRC_CAG	:= $(patsubst %,$(SRC_GRINC_PREFIX)GrinCode/Trf/%.cag,DropUnusedExpr NameIdents SparseCase NormForHPT NumberIdents CaseElimination SplitFetch DropUnusedBindings DropUnusedTags GrInline RightSkew LowerGrin CopyPropagation BuildAppBindings ReturningCatch CleanupPass Unbox2 TestUnbox)
...
GRINC_AGGRINCODE_ALLTRFLCL_DPDS_SRC_CAG	:= $(patsubst %,$(SRC_GRINC_PREFIX)GrinCode/%.cag,TrfLocal/CommonAliasAG TrfLocal/CommonRenameAG TrfLocal/CommonFreeVar TrfLocal/CommonWillEval)
