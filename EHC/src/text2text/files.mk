...
TEXT2TEXT_TEXT2TWIKI_DPDS_SRC_AG			:= $(patsubst %,$(SRC_TEXT2TEXT_PREFIX)%.ag,Text/AbsSyn Text/To/Common Text/To/CommonHeaderNumbering)
...
TEXT2TEXT_TEXT2HTML_MAIN_SRC_AG				:= $(patsubst %,$(SRC_TEXT2TEXT_PREFIX)%.ag,Text/To/Html)
TEXT2TEXT_TEXT2HTML_DPDS_SRC_AG				:= $(patsubst %,$(SRC_TEXT2TEXT_PREFIX)%.ag,Text/AbsSyn Text/To/Common Text/To/CommonHeaderNumbering)
$(patsubst $(SRC_TEXT2TEXT_PREFIX)%.ag,$(TEXT2TEXT_BLD_PREFIX)%.hs,$(TEXT2TEXT_TEXT2HTML_MAIN_SRC_AG)) \
											: $(TEXT2TEXT_TEXT2HTML_DPDS_SRC_AG)
...
TEXT2TEXT_AG_S_MAIN_SRC_AG					:= $(TEXT2TEXT_TEXT2DOCLTX_MAIN_SRC_AG) \
												...
												$(TEXT2TEXT_TEXT2HTML_MAIN_SRC_AG) \
...
$(TEXT2TEXT_BLD_EXEC): $(TEXT2TEXT_AG_ALL_MAIN_DRV_HS) $(TEXT2TEXT_HS_ALL_DRV_HS)
	$(GHC) --make -XImpredicativeTypes $(GHC_OPTS) $(GHC_OPTS_OPTIM) $(GHC_OPTS_WHEN_EHC) -i$(TEXT2TEXT_BLD_PREFIX) $(TEXT2TEXT_BLD_PREFIX)$(TEXT2TEXT_MAIN).hs -o $@
	$(STRIP) $@
