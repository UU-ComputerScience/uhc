...
$(TEXT2TEXT_BLD_EXEC): $(TEXT2TEXT_AG_ALL_MAIN_DRV_HS) $(TEXT2TEXT_HS_ALL_DRV_HS) $(LIB_EH_UTIL_INS_FLAG)
	$(GHC) --make -XImpredicativeTypes $(GHC_OPTS) $(GHC_OPTS_OPTIM) $(GHC_OPTS_WHEN_EHC) -package $(LIB_EH_UTIL_PKG_NAME) -i$(TEXT2TEXT_BLD_PREFIX) $(TEXT2TEXT_BLD_PREFIX)$(TEXT2TEXT_MAIN).hs -o $@
	$(STRIP) $@
