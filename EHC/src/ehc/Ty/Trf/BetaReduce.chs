...
%%[(11 hmtyinfer) module {%{EH}Ty.Trf.BetaReduce} import({%{EH}Base.HsName.Builtin}, {%{EH}Base.Common}, {%{EH}Base.TermLike}, {%{EH}Opts}, {%{EH}Ty.FitsInCommon}, {%{EH}Ty.FitsInCommon2}, {%{EH}Ty}, {%{EH}Gam.Full}, {%{EH}Substitutable}, {%{EH}VarMp})
%%]
...
%%]
%%[(1111 hmtyinfer) import({%{EH}Base.Debug})
%%]
