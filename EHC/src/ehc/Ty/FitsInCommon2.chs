...
%%][8
ppTyWithFI :: (VarLookupCmb VarMp gm, VarUpdatable Ty gm, VarUpdKey gm ~ VarId) => FIIn' gm -> Ty -> PP_Doc
%%]]
...
%%][8
ppTyWithFIFO :: (VarLookupCmb VarMp gm, VarUpdatable Ty gm, VarUpdKey gm ~ VarId) => FIIn' gm -> FIOut -> Ty -> PP_Doc
%%]]
