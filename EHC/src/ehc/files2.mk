...
uhc-light-cabal-dist: $(EHC_HS_ALL_DRV_HS_NO_MAIN) $(EHC_HS_MAIN_DRV_HS)		
	...
	mkdir -p $(CABALDIST_SRC_ALL_DRV_NO_MAIN_PREFIX) $(CABALDIST_SRC_PREFIX) $(CABALDIST_VARIANT_LIB_PREFIX) ; \
	...
	ehc_ehclib_names="`echo $${ehc_ehclib_files} | sed -e 's=\([^ ]*\)=$(call FUN_PREFIX2DIR,$(call FUN_VARIANT_LIB_PREFIX,$(EHC_VARIANT)))/\1=g' -e 's/ /,/g'`" ; \
	...
	$(call FUN_COPY_FILES_BY_TAR,$${ehc_ehclib_lib_dir},$(CABALDIST_VARIANT_LIB_PREFIX),$${ehc_ehclib_files}) ; \
