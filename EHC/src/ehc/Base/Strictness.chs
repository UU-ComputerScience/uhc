...
%%[(8 codegen || hmtyinfer) module {%{EH}Base.Strictness}
%%]

%%[(8 codegen || hmtyinfer) hs import({%{EH}Base.HsName})
%%]

%%[(50 codegen || hmtyinfer) hs import(Control.Monad, UHC.Util.Binary, UHC.Util.Serialize)
%%]

%%[(8 codegen || hmtyinfer) hs export(Strictness(..))
data Strictness
  = Strictness_Strict
