...
mkGenerRV :: String -> HsName
mkGenerRV = mkRV hsnModIntlBase0
%%]
...
%%[[1
      mkRV
%%][99
      (mkRV hsnModIntlBase0) -- (mkRV hsnModIntlBase)
%%]]
      [ "error" ]
%%]
...
%%[[9
      mkRV
%%][99
      (mkRV hsnModIntlBase2) -- (mkRV hsnModIntlShow)
%%]]
      [ "Show"
      , "show", "showsPrec"
...
%%[[9
      mkRV
%%][99
      (mkRV hsnModIntlBase3) -- (mkRV hsnModIntlRead)
%%]]
      [ "Read"
      , "read", "readsPrec"
      , "lex", "readParen"
...
%%[[97
      mkRV
%%][99
      (mkRV hsnModIntlBase4) -- (mkRV hsnModIntlFractional)
%%]]
      [ "fromRational" ]
%%]
...
%%[99 export(hsnModPrelude,hsnModIntlBase0)
...
hsnModIntlBase0                          =   hsnPrefixQual hsnUHC (hsnFromString "BaseZero")
hsnModIntlBase1                         =   hsnPrefixQual hsnUHC (hsnFromString "BaseOne")
hsnModIntlBase2                         =   hsnPrefixQual hsnUHC (hsnFromString "BaseTwo")
hsnModIntlBase3                         =   hsnPrefixQual hsnUHC (hsnFromString "BaseThree")
hsnModIntlBase4                         =   hsnPrefixQual hsnUHC (hsnFromString "BaseFour")
