...
%%[4 module {%{EHC}GamUtils} import(Data.List,{%{BASE}Common},{%{EHC}Opts},{%{AST}Ty},{%{TY}FitsInCommon},{%{EHC}TyFitsIn},{%{AST}Error},{%{EHC}Gam},{%{EHC}Cnstr},{%{EHC}Substitutable})
%%]

%%[4_2 import({%{TY}ElimAlts}) export(valGamElimAlts)
%%]

%%[11 import({%{TY}ElimEqual}) export(valGamElimEqual)
%%]
