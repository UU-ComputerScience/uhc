...
EHC_HS_UTIL_SRC_CHS						:= $(patsubst %,$(SRC_EHC_PREFIX)%.chs,\
													...
													$(addprefix Base/,TermLike AssocL UID Parser Parser2 Pragma Binary Serialize Strictness GenC GenJavaLike Hashable Target BasicAnnot Common Builtin Builtin2 HsName Debug TreeTrie CfgPP LaTeX HtmlCommon Bits FileSearchLocation PackageDatabase ParseUtils Optimize) \
													...
													$(addprefix Core/,Utils FFI Coercion Trf AsTy) \
