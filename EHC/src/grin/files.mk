...
GRIN_AGCODE_MAIN_SRC_CAG				:= $(patsubst %,$(SRC_GRIN_PREFIX)%.cag,GrinCode)
GRIN_AGCODE_DPDS_SRC_CAG				:= $(patsubst %,$(SRC_GRIN_PREFIX)%.cag,GrinCodeAbsSyn)
$(patsubst $(SRC_GRIN_PREFIX)%.cag,$(GRIN_BLD_VARIANT_PREFIX)%.hs,$(GRIN_AGCODE_MAIN_SRC_CAG)): $(patsubst $(SRC_GRIN_PREFIX)%.cag,$(GRIN_BLD_VARIANT_PREFIX)%.ag,$(GRIN_AGCODE_DPDS_SRC_CAG))

GRIN_AGCODE_PRETTY_MAIN_SRC_CAG			:= $(patsubst %,$(SRC_GRIN_PREFIX)%.cag,GrinCodePretty)
GRIN_AGCODE_PRETTY_DPDS_SRC_CAG			:= $(patsubst %,$(SRC_GRIN_PREFIX)%.cag,GrinCodeAbsSyn)
$(patsubst $(SRC_GRIN_PREFIX)%.cag,$(GRIN_BLD_VARIANT_PREFIX)%.hs,$(GRIN_AGCODE_PRETTY_MAIN_SRC_CAG)): $(patsubst $(SRC_GRIN_PREFIX)%.cag,$(GRIN_BLD_VARIANT_PREFIX)%.ag,$(GRIN_AGCODE_PRETTY_DPDS_SRC_CAG))
...
# derived
GRIN_AG_D_MAIN_DRV_AG					:= $(patsubst $(SRC_GRIN_PREFIX)%.cag,$(GRIN_BLD_VARIANT_PREFIX)%.ag,$(GRIN_AG_D_MAIN_SRC_CAG))
GRIN_AG_S_MAIN_DRV_AG					:= $(patsubst $(SRC_GRIN_PREFIX)%.cag,$(GRIN_BLD_VARIANT_PREFIX)%.ag,$(GRIN_AG_S_MAIN_SRC_CAG))
GRIN_AG_DS_MAIN_DRV_AG					:= $(patsubst $(SRC_GRIN_PREFIX)%.cag,$(GRIN_BLD_VARIANT_PREFIX)%.ag,$(GRIN_AG_DS_MAIN_SRC_CAG))
...
GRIN_AG_ALL_DPDS_DRV_AG					:= $(patsubst $(SRC_GRIN_PREFIX)%.cag,$(GRIN_BLD_VARIANT_PREFIX)%.ag,$(GRIN_AG_ALL_DPDS_SRC_CAG))

# rules
$(GRIN_AG_ALL_MAIN_DRV_AG) $(GRIN_AG_ALL_DPDS_DRV_AG): $(GRIN_BLD_VARIANT_PREFIX)%.ag: $(SRC_GRIN_PREFIX)%.cag $(SHUFFLE)
	mkdir -p $(@D)
