...
infer2pass-variant-dflt: $(INF2PS_ALL_DPDS) lib-eh-4_2
	mkdir -p $(dir $(INF2PS_BLD_EXEC))
	$(GHC) --make $(GHC_OPTS) -package $(call SUBS_US_X,EH4_2) -i$(INF2PS_BLD_VARIANT_PREFIX) $(INF2PS_BLD_VARIANT_PREFIX)$(INF2PS_MAIN).hs -o $(INF2PS_BLD_EXEC)
