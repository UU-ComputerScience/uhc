...
experiment-subst-variant-dflt: $(EXPERIMENTS_SUBST_ALL_DPDS)
	...
	$(GHC) --make $(GHC_OPTS) $(GHC_PLAIN_OPTS_WHEN_EXPERIMENTS_SUBST) -i$(BLD_EXPERIMENTS_SUBST_VARIANT_PREFIX) $(BLD_EXPERIMENTS_SUBST_VARIANT_PREFIX)$(EXPERIMENTS_SUBST_MAIN).hs -o $(EXPERIMENTS_SUBST_BLD_EXEC)
#	$(GHC) --make $(GHC_OPTS) $(GHC_PROF_OPTS_WHEN_EXPERIMENTS_SUBST) -i$(BLD_EXPERIMENTS_SUBST_VARIANT_PREFIX) $(BLD_EXPERIMENTS_SUBST_VARIANT_PREFIX)$(EXPERIMENTS_SUBST_MAIN).hs -o $(EXPERIMENTS_SUBST_BLD_EXEC_PROF)
