...
RTS_C_RTS_SRC_CC_OPTIM_O2	:= $(patsubst %,$(SRC_RTS_PREFIX)%.cc,grinbc/gbprim grinbc/gbprim-array grinbc/gbprim-integer grinbc/gbprim-C)
...
RTS_H_RTS_PRIM_DRV_H		:= $(addprefix $(RTS_BLD_RTS_PREFIX),prim.h grinbc/gbprim.h grinbc/gbprim-array.h grinbc/gbprim-integer.h grinbc/gbprim-C.h)
