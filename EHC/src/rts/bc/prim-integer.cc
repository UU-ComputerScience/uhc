...
#define GB_Integer_DivMod_In_Ensured(z1,z2,x,y)		GB_Integer_Op2_In2_Ensured(mpz_fdiv_qr,z1,z2,x,y)
...
#define GB_Integer_QuotRem_In_Ensured(z1,z2,x,y)	GB_Integer_Op2_In2_Ensured(mpz_tdiv_qr,z1,z2,x,y)
