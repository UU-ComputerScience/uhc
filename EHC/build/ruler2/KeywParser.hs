module KeywParser
( specialChars, opChars, propsSynInhMp, propsDirMp, propsMp
, keywordsTextDir, keywordsTextProps, keywordsTextEscapable, keywordsText, keywordsOpsEsc
, keywordsOpsExplainEsc, keywordsOpsParenEsc, keywordsOps
, mkScan, mkHScan, mkOffScan
, pKeySPos, pNmStr, pNmStrSPos, pNmStrI, pNmStrISPos, pSymEscStr, pSymEscStrSPos, pSymStr, pSymStrSPos )
where
