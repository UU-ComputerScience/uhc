...
-- UUAGC 0.9.39.1 (build/ruler2/Expr/IsRw.ag)
module Expr.IsRw(exprIsRw) where
...
-- semantic domain
type T_AGExprItf  = ( ExprIsRw)
data Inh_AGExprItf  = Inh_AGExprItf {}
data Syn_AGExprItf  = Syn_AGExprItf {exprIsRw_Syn_AGExprItf :: ExprIsRw}
wrap_AGExprItf :: T_AGExprItf  ->
                  Inh_AGExprItf  ->
                  Syn_AGExprItf 
wrap_AGExprItf sem (Inh_AGExprItf )  =
    (let ( _lhsOexprIsRw) = sem 
     in  (Syn_AGExprItf _lhsOexprIsRw ))
