...
-- UUAGC 0.9.39.1 (build/101/lib-ehc/EH101/Core/Trf/ElimTrivApp.ag)
module EH101.Core.Trf.ElimTrivApp(cmodTrfElimTrivApp) where
                       ...
                       (case (_lhsIevalCtx) of
                        ...
                        (case (True) of
                         ...
                         (case (expr_1 _exprOevalCtx _exprOisLamBody _exprOisStrict _exprOisTopApp _exprOisTopTup _exprOlev _exprOopts _exprOwhatAbove ) of
                          { ( _exprIappFunKind,_exprIargL,_exprIcTrf,_exprIfvS,_exprImbFunVar,_exprImbLam,_exprImbVar) | True ->
                              (case (_lev) of
                               { _patOlev | _patOlev `seq` (True) ->
                               (case (pat_ _patOlev _patOopts ) of
                                { ( _patIcTrf,_patIfldNmL,_patIfvS,_patImbCTag,_patInmL) | True ->
                                      ...
                                      (case (_exprIfvS `Set.difference` Set.fromList _patInmL) of
                                       ...
                                       (case (_fvS) of
                                        ...
                                        (case (_patImbCTag) of
                                         ...
                                         ( _lhsOcTrf,_lhsOfvS,_lhsOmbCTag) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }))
-- CAltL -------------------------------------------------------
{-
   visit 0:
      inherited attributes:
                      ...
                      (case (_lhsIisLamBody) of
                       ...
                       (case (_lhsIevalCtx) of
                        ...
                        (case (hd_ _hdOevalCtx _hdOisLamBody _hdOisStrict _hdOlev _hdOopts ) of
                         { ( _hdIcTrf,_hdIfvS,_hdImbCTag) | True ->
...
type T_CExpr_1  = EvalCtx ->
                  ...
                  EHCOpts ->
                  WhatExpr ->
                  ( AppFunKind,([CBound]),CExpr ,FvS,(Maybe HsName),(Maybe [HsName]),(Maybe HsName))
                                                        ...
                                                        (case (_exprImbFunVar) of
                                                         ...
                                                         (case (_exprImbLam) of
                                                          ...
                                                          (case (_exprImbVar) of
                                                           ...
                                                           ( _lhsOappFunKind,_lhsOargL,_lhsOcTrf,_lhsOfvS,_lhsOmbFunVar,_lhsOmbLam,_lhsOmbVar) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }))
                                        ...
                                        (case (_lhsIevalCtx) of
                                         ...
                                         (case (False) of
                                          ...
                                          (case (func_1 _funcOevalCtx _funcOisLamBody _funcOisStrict _funcOisTopApp _funcOisTopTup _funcOlev _funcOopts _funcOwhatAbove ) of
                                           { ( _funcIappFunKind,_funcIargL,_funcIcTrf,_funcIfvS,_funcImbFunVar,_funcImbLam,_funcImbVar) | True ->
                                                                  ...
                                                                  (case (_argL) of
                                                                   ...
                                                                   (case (CExpr_App _funcIcTrf _argIcTrf) of
                                                                    ...
                                                                    (case (if _lhsIisTopApp
                                                                           then case (_funcImbFunVar,reverse _argL) of
                                                                                  (Just f,[a]) | f == (ehcOptBuiltin _lhsIopts ehbnId)
                                                                                    -> acoreUnBoundVal a
                                                                                  _ -> _cTrf
                                                                           else _cTrf) of
                                                                     { _lhsOcTrf | _lhsOcTrf `seq` (True) ->
                                              ...
                                              (case (_lhsIisLamBody) of
                                               ...
                                               (case (_lhsIevalCtx) of
                                                ...
                                                (case (dflt_1 _dfltOevalCtx _dfltOisLamBody _dfltOisStrict _dfltOisTopApp _dfltOisTopTup _dfltOlev _dfltOopts _dfltOwhatAbove ) of
                                                 { ( _dfltIappFunKind,_dfltIargL,_dfltIcTrf,_dfltIfvS,_dfltImbFunVar,_dfltImbLam,_dfltImbVar) | True ->
                                                     (case (_lhsIlev) of
                                        ...
                                        (case (_lhsIisLamBody) of
                                         ...
                                         (case (_lhsIevalCtx) of
                                          ...
                                          (case (errorExpr_1 _errorExprOevalCtx _errorExprOisLamBody _errorExprOisStrict _errorExprOisTopApp _errorExprOisTopTup _errorExprOlev _errorExprOopts _errorExprOwhatAbove ) of
                                           { ( _errorExprIappFunKind,_errorExprIargL,_errorExprIcTrf,_errorExprIfvS,_errorExprImbFunVar,_errorExprImbLam,_errorExprImbVar) | True ->
                                           ...
                                           (case (_lhsIisLamBody) of
                                            ...
                                            (case (_lhsIevalCtx) of
                                             ...
                                             (case (body_1 _bodyOevalCtx _bodyOisLamBody _bodyOisStrict _bodyOisTopApp _bodyOisTopTup _bodyOlev _bodyOopts _bodyOwhatAbove ) of
                                              { ( _bodyIappFunKind,_bodyIargL,_bodyIcTrf,_bodyIfvS,_bodyImbFunVar,_bodyImbLam,_bodyImbVar) | True ->
                                             ...
                                             (case (_lhsIisLamBody) of
                                              ...
                                              (case (_lhsIevalCtx) of
                                               ...
                                               (case (offset_1 _offsetOevalCtx _offsetOisLamBody _offsetOisStrict _offsetOisTopApp _offsetOisTopTup _offsetOlev _offsetOopts _offsetOwhatAbove ) of
                                                { ( _offsetIappFunKind,_offsetIargL,_offsetIcTrf,_offsetIfvS,_offsetImbFunVar,_offsetImbLam,_offsetImbVar) | True ->
                                                    (case (expr_ ) of
                                                     { ( _exprIwhatBelow,expr_1) | True ->
                                                         (case (_whatAbove) of
                                                          { _exprOwhatAbove | _exprOwhatAbove `seq` (True) ->
                                               ...
                                               (case (_lhsIisLamBody) of
                                                ...
                                                (case (_lhsIevalCtx) of
                                                 ...
                                                 (case (fldExpr_1 _fldExprOevalCtx _fldExprOisLamBody _fldExprOisStrict _fldExprOisTopApp _fldExprOisTopTup _fldExprOlev _fldExprOopts _fldExprOwhatAbove ) of
                                                  { ( _fldExprIappFunKind,_fldExprIargL,_fldExprIcTrf,_fldExprIfvS,_fldExprImbFunVar,_fldExprImbLam,_fldExprImbVar) | True ->
                                                      (case (offset_ ) of
                                                       { ( _offsetIwhatBelow,offset_1) | True ->
                                                           (case (_whatAbove) of
                                                            { _offsetOwhatAbove | _offsetOwhatAbove `seq` (True) ->
...
type T_CPat  = Int ->
               EHCOpts ->
               ( CPat ,([HsName]),FvS,(Maybe CTag),([HsName]))
           ...
           (case ([]) of
            ...
            (case (Set.empty) of
             ...
             (case (Nothing) of
              ...
              (case ([]) of
               { _lhsOnmL | _lhsOnmL `seq` (True) ->
               ( _lhsOcTrf,_lhsOfldNmL,_lhsOfvS,_lhsOmbCTag,_lhsOnmL) }) }) }) }) }) }))
sem_CPat_Char :: Char ->
                 T_CPat 
sem_CPat_Char char_  =
    (\ _lhsIlev
                     ...
                     (case (_lhsIevalCtx) of
                      ...
                      (case (True) of
                       ...
                       (case (just_1 _justOevalCtx _justOisLamBody _justOisStrict _justOisTopApp _justOisTopTup _justOlev _justOopts _justOwhatAbove ) of
                        { ( _justIappFunKind,_justIargL,_justIcTrf,_justIfvS,_justImbFunVar,_justImbLam,_justImbVar) | True ->
