...
-- UUAGC 0.9.39.1 (build/101/lib-ehc/EH101/Core/Trf/FloatToGlobal.ag)
module EH101.Core.Trf.FloatToGlobal(cmodTrfFloatToGlobal) where
                      ...
                      (case (_lhsIevalCtx) of
                       ...
                       (case (True) of
                        ...
                        (case (True) of
                         ...
                         (case (expr_1 _exprOevalCtx _exprOisLamBody _exprOisLocalInInstance _exprOisStrict _exprOisTopApp _exprOisTopTup _exprOlev _exprOwhatAbove ) of
                          { ( _exprIappFunKind,_exprIcFloatedBindGrps,_exprIcTrf,_exprIfvS,_exprIisClosurableExpr,_exprImbLam,_exprImbVar) | True ->
...
{-
   visit 0:
      inherited attributes:
         ...
         isGlobal             : Bool
         isLamBody            : Bool
         isLocalInInstance    : Bool
         isStrict             : Bool
         letBindingsCateg     : CBindCateg
         lev                  : Int
      synthesized attributes:
         cFloatedBindGrps     : Seq.FastSeq (CBindCateg,Seq.FastSeq CBind)
         cLamBinds            : Seq.FastSeq CBind
         cLargeCAFBinds       : Seq.FastSeq CBind
         cSmallCAFBinds       : Seq.FastSeq CBind
         cTrf                 : SELF 
         fvS                  : FvS
         fvSMp                : FvSMp
         nm                   : HsName
              ...
              (case (_lhsIisGlobal) of
               ...
               (case (_lhsIevalCtx) of
                ...
                (case (nm_) of
                 ...
                 (case (bindAspects_ _bindAspectsOevalCtx _bindAspectsOisGlobal _bindAspectsOisLamBody _bindAspectsOisLocalInInstance _bindAspectsOisStrict _bindAspectsOletBindingsCateg _bindAspectsOlev _bindAspectsOnm ) of
              ...
              (case (_lhsIisStrict) of
               ...
               (case (_lhsIisLamBody) of
                ...
                (case (_lhsIisGlobal) of
                 ...
                 (case (_lhsIevalCtx) of
                  { _tlOevalCtx | _tlOevalCtx `seq` (True) ->
                  (case (tl_ _tlOevalCtx _tlOisGlobal _tlOisLamBody _tlOisLocalInInstance _tlOisStrict _tlOletBindingsCateg _tlOlev ) of
                        ...
                        (case (_lhsIisStrict) of
                         ...
                         (case (_lhsIisLamBody) of
                          ...
                          (case (_lhsIisGlobal) of
                           ...
                           (case (_lhsIevalCtx) of
                            { _hdOevalCtx | _hdOevalCtx `seq` (True) ->
                            (case (hd_ _hdOevalCtx _hdOisGlobal _hdOisLamBody _hdOisLocalInInstance _hdOisStrict _hdOletBindingsCateg _hdOlev ) of
   ...
   alternatives:
      alternative Bind:
         ...
         visit 0:
            ...
            local cBindTrf    : _
            local _tup1       : {(Seq.FastSeq CBind,Seq.FastSeq CBind,Seq.FastSeq CBind)}
      alternative FFE:
               ...
               (case (_lhsIisStrict) of
                ...
                (case (_lhsIisLamBody) of
                 ...
                 (case (_lhsIisGlobal) of
                  ...
                  (case (_lhsIevalCtx) of
                   { _tlOevalCtx | _tlOevalCtx `seq` (True) ->
                   (case (tl_ _tlOevalCtx _tlOisGlobal _tlOisLamBody _tlOisLocalInInstance _tlOisStrict _tlOletBindingsCateg _tlOlev _tlOnm ) of
                    { ( _tlIcFloatedBindGrps,_tlIcLamBinds,_tlIcLargeCAFBinds,_tlIcSmallCAFBinds,_tlIcTrf,_tlIfvS,_tlIfvSMp,_tlInmL) | True ->
                        (case (_lhsInm) of
                             ...
                             (case (_lhsIevalCtx) of
                              ...
                              (case (True) of
                               ...
                               (case (True) of
                                ...
                                (case (hd_ _hdOevalCtx _hdOisGlobal _hdOisLamBody _hdOisLocalInInstance _hdOisStrict _hdOisTopApp _hdOisTopTup _hdOletBindingsCateg _hdOlev _hdOnm ) of
   ...
   alternatives:
      ...
      alternative Let:
         ...
         visit 1:
            ...
            local evalCtx     : _
            local _tup2       : _
            local bindingsToFloat : _
            local whatAbove   : {WhatExpr}
            local isTopTup    : _
            local isTopApp    : {Bool}
            local bindingGroupsToPossiblyFloat : _
            local bindingsToKeep : _
            local bindingGroupsToCertainlyInsert : _
            local _tup3       : _
            local bindingGroupsToFloat : _
            local bindingGroupsToInsert : _
            local fvS         : _
      alternative String:
         child str            : {String}
         visit 0:
...
type T_CExpr_1  = EvalCtx ->
                  ...
                  Int ->
                  WhatExpr ->
                  ( AppFunKind,(Seq.FastSeq (CBindCateg,Seq.FastSeq CBind)),CExpr ,FvS,Bool,(Maybe [HsName]),(Maybe HsName))
                                                        ...
                                                        (case (_exprIisClosurableExpr) of
                                                         ...
                                                         (case (_exprImbLam) of
                                                          ...
                                                          (case (_exprImbVar) of
                                                           ...
                                                           ( _lhsOappFunKind,_lhsOcFloatedBindGrps,_lhsOcTrf,_lhsOfvS,_lhsOisClosurableExpr,_lhsOmbLam,_lhsOmbVar) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }))
                                        ...
                                        (case (_lhsIisLamBody) of
                                         ...
                                         (case (_lhsIevalCtx) of
                                          ...
                                          (case (False) of
                                           ...
                                           (case (func_1 _funcOevalCtx _funcOisLamBody _funcOisLocalInInstance _funcOisStrict _funcOisTopApp _funcOisTopTup _funcOlev _funcOwhatAbove ) of
                                            { ( _funcIappFunKind,_funcIcFloatedBindGrps,_funcIcTrf,_funcIfvS,_funcIisClosurableExpr,_funcImbLam,_funcImbVar) | True ->
                                                          ...
                                                          (case (_lhsIevalCtx) of
                                                           ...
                                                           (case (hsnUnknown) of
                                                            ...
                                                            (case (True) of
                                                             ...
                                                             (case (arg_ _argOevalCtx _argOisGlobal _argOisLamBody _argOisLocalInInstance _argOisStrict _argOisTopApp _argOisTopTup _argOletBindingsCateg _argOlev _argOnm ) of
                                             ...
                                             (case (_lhsIisStrict) of
                                              ...
                                              (case (_lhsIisLamBody) of
                                               ...
                                               (case (_lhsIevalCtx) of
                                                ...
                                                (case (dflt_1 _dfltOevalCtx _dfltOisLamBody _dfltOisLocalInInstance _dfltOisStrict _dfltOisTopApp _dfltOisTopTup _dfltOlev _dfltOwhatAbove ) of
                                                 { ( _dfltIappFunKind,_dfltIcFloatedBindGrps,_dfltIcTrf,_dfltIfvS,_dfltIisClosurableExpr,_dfltImbLam,_dfltImbVar) | True ->
                                                     (case (_lhsIisStrict) of
                                        ...
                                        (case (_isLocalInInstance) of
                                         ...
                                         (case (_lhsIisLamBody) of
                                          ...
                                          (case (_lhsIevalCtx) of
                                           ...
                                           (case (errorExpr_1 _errorExprOevalCtx _errorExprOisLamBody _errorExprOisLocalInInstance _errorExprOisStrict _errorExprOisTopApp _errorExprOisTopTup _errorExprOlev _errorExprOwhatAbove ) of
                                            { ( _errorExprIappFunKind,_errorExprIcFloatedBindGrps,_errorExprIcTrf,_errorExprIfvS,_errorExprIisClosurableExpr,_errorExprImbLam,_errorExprImbVar) | True ->
                                          ...
                                          (case (_lhsIisStrict) of
                                           ...
                                           (case (_lhsIisLamBody) of
                                            ...
                                            (case (_lhsIevalCtx) of
                                             ...
                                             (case (body_1 _bodyOevalCtx _bodyOisLamBody _bodyOisLocalInInstance _bodyOisStrict _bodyOisTopApp _bodyOisTopTup _bodyOlev _bodyOwhatAbove ) of
                                              { ( _bodyIappFunKind,_bodyIcFloatedBindGrps,_bodyIcTrf,_bodyIfvS,_bodyIisClosurableExpr,_bodyImbLam,_bodyImbVar) | True ->
                                                         ...
                                                         (case (False) of
                                                          ...
                                                          (case (_isGlobal) of
                                                           ...
                                                           (case (_lhsIevalCtx) of
                                                            ...
                                                            (case (bind_ _bindOevalCtx _bindOisGlobal _bindOisLamBody _bindOisLocalInInstance _bindOisStrict _bindOletBindingsCateg _bindOlev ) of
                                    ...
                                    (case (if categ_ == CBindCateg_Strict
                                     ...
                                     (case (_evalCtx) of
                                      ...
                                      (case (_isGlobal || categ_ == CBindCateg_Strict) of
                                       ...
                                       (case (binds_ _bindsOevalCtx _bindsOisGlobal _bindsOisLamBody _bindsOisLocalInInstance _bindsOisStrict _bindsOletBindingsCateg _bindsOlev ) of
                                            ...
                                            (case (_lhsIisStrict) of
                                             ...
                                             (case (_lhsIisLamBody) of
                                              ...
                                              (case (_lhsIevalCtx) of
                                               ...
                                               (case (offset_1 _offsetOevalCtx _offsetOisLamBody _offsetOisLocalInInstance _offsetOisStrict _offsetOisTopApp _offsetOisTopTup _offsetOlev _offsetOwhatAbove ) of
                                                { ( _offsetIappFunKind,_offsetIcFloatedBindGrps,_offsetIcTrf,_offsetIfvS,_offsetIisClosurableExpr,_offsetImbLam,_offsetImbVar) | True ->
                                                    (case (expr_ ) of
                                                     { ( _exprIwhatBelow,expr_1) | True ->
                                                         (case (_whatAbove) of
                                                          { _exprOwhatAbove | _exprOwhatAbove `seq` (True) ->
                                              ...
                                              (case (_lhsIisStrict) of
                                               ...
                                               (case (_lhsIisLamBody) of
                                                ...
                                                (case (_lhsIevalCtx) of
                                                 ...
                                                 (case (fldExpr_1 _fldExprOevalCtx _fldExprOisLamBody _fldExprOisLocalInInstance _fldExprOisStrict _fldExprOisTopApp _fldExprOisTopTup _fldExprOlev _fldExprOwhatAbove ) of
                                                  { ( _fldExprIappFunKind,_fldExprIcFloatedBindGrps,_fldExprIcTrf,_fldExprIfvS,_fldExprIisClosurableExpr,_fldExprImbLam,_fldExprImbVar) | True ->
                                                      (case (offset_ ) of
                                                       { ( _offsetIwhatBelow,offset_1) | True ->
                                                           (case (_whatAbove) of
                                                            { _offsetOwhatAbove | _offsetOwhatAbove `seq` (True) ->
...
type T_MbCExpr  = EvalCtx ->
                  ...
                  Bool ->
                  Int ->
                  ( (Seq.FastSeq (CBindCateg,Seq.FastSeq CBind)),MbCExpr ,FvS)
    ...
    (\ _lhsIevalCtx
       ...
       _lhsIlev ->
         (case (_lhsIlev) of
          ...
          (case (_lhsIisLocalInInstance) of
           { _justOisLocalInInstance | _justOisLocalInInstance `seq` (True) ->
           (case (just_ ) of
                    ...
                    (case (_lhsIevalCtx) of
                     ...
                     (case (True) of
                      ...
                      (case (True) of
                       ...
                       (case (just_1 _justOevalCtx _justOisLamBody _justOisLocalInInstance _justOisStrict _justOisTopApp _justOisTopTup _justOlev _justOwhatAbove ) of
                        { ( _justIappFunKind,_justIcFloatedBindGrps,_justIcTrf,_justIfvS,_justIisClosurableExpr,_justImbLam,_justImbVar) | True ->
                            (case (_justIcFloatedBindGrps) of
                             { _lhsOcFloatedBindGrps | _lhsOcFloatedBindGrps `seq` (True) ->
