...
-- UUAGC 0.9.39.1 (build/101/lib-ehc/EH101/Core/Trf/AnnBasedSimplify.a)
module EH101.Core.Trf.AnnBasedSimplify(cmodTrfAnnBasedSimplify) where
                       ...
                       (case (_lhsIisLamBody) of
                        ...
                        (case (_lhsIevalCtx) of
                         ...
                         (case (True) of
                          ...
                          (case (expr_1 _exprOevalCtx _exprOisLamBody _exprOisStrict _exprOisTopApp _exprOisTopTup _exprOlev _exprOopts _exprOpropDown _exprOwhatAbove ) of
                           { ( _exprIappFunKind,_exprIargL,_exprIcTrf,_exprImbFunVar,_exprImbLam,_exprImbVar,_exprIpropUp,_exprIpropUpL) | True ->
                               (case (_lev) of
              ...
              (case (_lhsIisStrict) of
               ...
               (case (_lhsIisLamBody) of
                ...
                (case (_lhsIevalCtx) of
                 ...
                 (case (tl_ _tlOevalCtx _tlOisLamBody _tlOisStrict _tlOlev _tlOopts _tlOpropDown ) of
                  { ( _tlIcTrf) | True ->
                      (case (_lhsIlev) of
                       ...
                       (case (_lhsIisStrict) of
                        ...
                        (case (_lhsIisLamBody) of
                         ...
                         (case (_lhsIevalCtx) of
                          ...
                          (case (hd_ _hdOevalCtx _hdOisLamBody _hdOisStrict _hdOlev _hdOopts _hdOpropDown ) of
                             ...
                             (case (_lhsIisGlobal) of
                              ...
                              (case (_lhsIevalCtx) of
                               ...
                               (case (True) of
                                ...
                                (case (Prop_None) of
                                 { _hdOpropDown | _hdOpropDown `seq` (True) ->
                                 (case (hd_ _hdOevalCtx _hdOisGlobal _hdOisLamBody _hdOisStrict _hdOisTopApp _hdOisTopTup _hdOletBindingsCateg _hdOlev _hdOnm _hdOopts _hdOpropDown ) of
...
type T_CExpr_1  = EvalCtx ->
                  ...
                  Prop ->
                  WhatExpr ->
                  ( AppFunKind,([CBound]),CExpr ,(Maybe HsName),(Maybe [HsName]),(Maybe HsName),Prop,([Prop]))
                                                           ...
                                                           (case (Prop_None) of
                                                            ...
                                                            (case (_propUp) of
                                                             ...
                                                             (case (_exprIpropUpL) of
                                                              ...
                                                              ( _lhsOappFunKind,_lhsOargL,_lhsOcTrf,_lhsOmbFunVar,_lhsOmbLam,_lhsOmbVar,_lhsOpropUp,_lhsOpropUpL) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }))
                                         ...
                                         (case (_lhsIisLamBody) of
                                          ...
                                          (case (_lhsIevalCtx) of
                                           ...
                                           (case (False) of
                                            ...
                                            (case (func_1 _funcOevalCtx _funcOisLamBody _funcOisStrict _funcOisTopApp _funcOisTopTup _funcOlev _funcOopts _funcOpropDown _funcOwhatAbove ) of
                                             { ( _funcIappFunKind,_funcIargL,_funcIcTrf,_funcImbFunVar,_funcImbLam,_funcImbVar,_funcIpropUp,_funcIpropUpL) | True ->
                                                            ...
                                                            (case (_isGlobal) of
                                                             ...
                                                             (case (_lhsIevalCtx) of
                                                              ...
                                                              (case (hsnUnknown) of
                                                               ...
                                                               (case (arg_ _argOevalCtx _argOisGlobal _argOisLamBody _argOisStrict _argOisTopApp _argOisTopTup _argOletBindingsCateg _argOlev _argOnm _argOopts _argOpropDown ) of
                                                                                      ...
                                                                                      (Just f,[_,(e,Prop_IsIntegerConst i)],Prop_HasTy t)
                                                                                        ...
                                                                                        -> if t == tyInt
                                                                                           ...
                                                                                           then
                                                                                                ...
                                                                                                then Prop_IsInteger $ acoreApp (acoreVar $ ehcOptBuiltin _lhsIopts ehbnPrimIntToInteger) [acoreInt2 i]
                                                ...
                                                (case (_lhsIisStrict) of
                                                 ...
                                                 (case (_lhsIisLamBody) of
                                                  ...
                                                  (case (_lhsIevalCtx) of
                                                   ...
                                                   (case (dflt_1 _dfltOevalCtx _dfltOisLamBody _dfltOisStrict _dfltOisTopApp _dfltOisTopTup _dfltOlev _dfltOopts _dfltOpropDown _dfltOwhatAbove ) of
                                                    { ( _dfltIappFunKind,_dfltIargL,_dfltIcTrf,_dfltImbFunVar,_dfltImbLam,_dfltImbVar,_dfltIpropUp,_dfltIpropUpL) | True ->
                                                        (case (_lhsIlev) of
                                                         ...
                                                         (case (_lhsIisStrict) of
                                                          ...
                                                          (case (_lhsIisLamBody) of
                                                           ...
                                                           (case (_lhsIevalCtx) of
                                                            ...
                                                            (case (alts_ _altsOevalCtx _altsOisLamBody _altsOisStrict _altsOlev _altsOopts _altsOpropDown ) of
                                                             { ( _altsIcTrf) | True ->
                                                                 (case (expr_ ) of
                                                                  { ( _exprIwhatBelow,expr_1) | True ->
                                                                      (case (_whatAbove) of
                                        ...
                                        (case (_lhsIisStrict) of
                                         ...
                                         (case (_lhsIisLamBody) of
                                          ...
                                          (case (_lhsIevalCtx) of
                                           ...
                                           (case (errorExpr_1 _errorExprOevalCtx _errorExprOisLamBody _errorExprOisStrict _errorExprOisTopApp _errorExprOisTopTup _errorExprOlev _errorExprOopts _errorExprOpropDown _errorExprOwhatAbove ) of
                                            { ( _errorExprIappFunKind,_errorExprIargL,_errorExprIcTrf,_errorExprImbFunVar,_errorExprImbLam,_errorExprImbVar,_errorExprIpropUp,_errorExprIpropUpL) | True ->
                                           ...
                                           (case (_lhsIisStrict) of
                                            ...
                                            (case (_lhsIisLamBody) of
                                             ...
                                             (case (_lhsIevalCtx) of
                                              ...
                                              (case (body_1 _bodyOevalCtx _bodyOisLamBody _bodyOisStrict _bodyOisTopApp _bodyOisTopTup _bodyOlev _bodyOopts _bodyOpropDown _bodyOwhatAbove ) of
                                               { ( _bodyIappFunKind,_bodyIargL,_bodyIcTrf,_bodyImbFunVar,_bodyImbLam,_bodyImbVar,_bodyIpropUp,_bodyIpropUpL) | True ->
                                              ...
                                              (case (_lhsIisStrict) of
                                               ...
                                               (case (_lhsIisLamBody) of
                                                ...
                                                (case (_lhsIevalCtx) of
                                                 ...
                                                 (case (offset_1 _offsetOevalCtx _offsetOisLamBody _offsetOisStrict _offsetOisTopApp _offsetOisTopTup _offsetOlev _offsetOopts _offsetOpropDown _offsetOwhatAbove ) of
                                                  { ( _offsetIappFunKind,_offsetIargL,_offsetIcTrf,_offsetImbFunVar,_offsetImbLam,_offsetImbVar,_offsetIpropUp,_offsetIpropUpL) | True ->
                                                      (case (expr_ ) of
                                                       { ( _exprIwhatBelow,expr_1) | True ->
                                                           (case (_whatAbove) of
                                                            { _exprOwhatAbove | _exprOwhatAbove `seq` (True) ->
                                                 ...
                                                 (case (_lhsIisStrict) of
                                                  ...
                                                  (case (_lhsIisLamBody) of
                                                   ...
                                                   (case (_lhsIevalCtx) of
                                                    ...
                                                    (case (fldExpr_1 _fldExprOevalCtx _fldExprOisLamBody _fldExprOisStrict _fldExprOisTopApp _fldExprOisTopTup _fldExprOlev _fldExprOopts _fldExprOpropDown _fldExprOwhatAbove ) of
                                                     { ( _fldExprIappFunKind,_fldExprIargL,_fldExprIcTrf,_fldExprImbFunVar,_fldExprImbLam,_fldExprImbVar,_fldExprIpropUp,_fldExprIpropUpL) | True ->
                                                         (case (offset_ ) of
                                                          { ( _offsetIwhatBelow,offset_1) | True ->
                                                              (case (_whatAbove) of
                                                               { _offsetOwhatAbove | _offsetOwhatAbove `seq` (True) ->
...
sem_MbCExpr_Just just_  =
    (\ _lhsIevalCtx
       ...
       _lhsIpropDown ->
         (case (_lhsIpropDown) of
          { _justOpropDown | _justOpropDown `seq` (True) ->
          (case (_lhsIopts) of
                     ...
                     (case (_lhsIisLamBody) of
                      ...
                      (case (_lhsIevalCtx) of
                       ...
                       (case (True) of
                        ...
                        (case (just_1 _justOevalCtx _justOisLamBody _justOisStrict _justOisTopApp _justOisTopTup _justOlev _justOopts _justOpropDown _justOwhatAbove ) of
                         { ( _justIappFunKind,_justIargL,_justIcTrf,_justImbFunVar,_justImbLam,_justImbVar,_justIpropUp,_justIpropUpL) | True ->
