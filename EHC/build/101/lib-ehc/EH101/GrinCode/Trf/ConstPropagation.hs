...
-- UUAGC 0.9.39.1 (build/101/lib-ehc/EH101/GrinCode/Trf/ConstPropagati)
module EH101.GrinCode.Trf.ConstPropagation(grConstPropagation) where
...
sem_GrAGItf_AGItf module_  =
    (let _lhsOtrf :: GrModule 
         ...
         -- "build/101/lib-ehc/EH101/GrinCode/Trf/ConstPropagation.ag"(line 37, column 25)
         _mkNewNm =
             id
         -- copy rule (up)
         _lhsOtrf =
    ...
    (\ _lhsImkNewNm
       _lhsInmAliasMp ->
         (let _bodyOnmAliasMp :: NmAliasMp
              ...
              _bodyInmAlias :: NmAlias
              _bodyItrf :: GrExpr 
              -- "build/101/lib-ehc/EH101/GrinCode/Trf/ConstPropagation.ag"(line 40, column 17)
              _bodyOnmAliasMp =
                  _newNmAliasMp `Map.union` _lhsInmAliasMp
              -- "build/101/lib-ehc/EH101/GrinCode/Trf/ConstPropagation.ag"(line 45, column 33)
              __tup1 =
                  case (_exprInmAlias,_patInmAlias,_bodyInmAlias) of
                    (c@(NmAlias_Const _ _),pp@(NmAlias_Nm p),_)
                      -> (_trf,Map.singleton p (c {naliNm = p}))
                    (NmAlias_Nm e,_,_) | isJust mbAli
                      -> case mbAli of
                           Just (NmAlias_Const _ c)
                             -> (GrExpr_Seq (GrExpr_Unit c GrType_None) _patItrf _bodyItrf,Map.empty)
                           _ -> (_trf,Map.empty)
              ...
              (_,_newNmAliasMp) =
                  __tup1
              -- "build/101/lib-ehc/EH101/GrinCode/Trf/ConstPropagation.ag"(line 56, column 17)
              _lhsOtrf =
                  _seqTrf
