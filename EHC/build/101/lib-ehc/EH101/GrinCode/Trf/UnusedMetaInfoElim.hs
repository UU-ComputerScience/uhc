...
-- UUAGC 0.9.39.1 (build/101/lib-ehc/EH101/GrinCode/Trf/UnusedMetaInfo)
module EH101.GrinCode.Trf.UnusedMetaInfoElim(grUnusedMetaInfoElim) where
...
sem_GrModule_Mod moduleNm_ globalL_ bindL_ tagsMp_  =
    (case (bindL_ ) of
     { ( _bindLItrf) ->
         (case (GrModule_Mod moduleNm_ [] _bindLItrf Map.empty) of
          { _lhsOtrf ->
          ( _lhsOtrf) }) })
-- GrPatAlt ----------------------------------------------------
{-
