...
-- UUAGC 0.9.39.1 (build/101/lib-ehc/EH101/GrinCode/Trf/UnusedNameElim)
module EH101.GrinCode.Trf.UnusedNameElim(grUnusedNameElim) where
...
-- semantic domain
type T_GrAdapt  = ( FvInfoMp,GrAdapt )
sem_GrAdapt_Del :: T_GrVal  ->
                   T_GrAdapt 
sem_GrAdapt_Del off_  =
    (case (off_ ) of
     { ( _offIgathFviMp,_offInmAlias,_offItrf) ->
...
sem_GrAdapt_Ins off_ val_  =
    (case (val_ ) of
     { ( _valIgathFviMp,_valInmAlias,_valItrf) ->
         (case (off_ ) of
          { ( _offIgathFviMp,_offInmAlias,_offItrf) ->
...
-- semantic domain
type T_GrAdaptL  = ( FvInfoMp,GrAdaptL )
...
sem_GrAlt_Alt ann_ pat_ expr_  =
    (case (expr_ ) of
     { ( _exprIgathFviMp,_exprIhasSideEffect,_exprInmAlias,_exprItrf) ->
         (case (pat_ ) of
...
-- semantic domain
type T_GrBindL  = ( FvInfoMp,GrBindL )
...
-- semantic domain
type T_GrExpr  = ( FvInfoMp,Bool,NmAlias,GrExpr )
sem_GrExpr_App :: HsName ->
                  T_GrValL  ->
                  T_GrExpr 
sem_GrExpr_App nm_ argL_  =
    (case (argL_ ) of
     { ( _argLIgathFviMp,_argLInmAliasL,_argLItrf) ->
           ...
           (case (False) of
            ...
            (case (NmAlias_None) of
             ...
             (case (GrExpr_App nm_ _argLItrf) of
              ...
              (case (_trf) of
               { _lhsOtrf ->
               ( _lhsOgathFviMp,_lhsOhasSideEffect,_lhsOnmAlias,_lhsOtrf) }) }) }) }) }) }) })
...
sem_GrExpr_Catch body_ arg_ handler_  =
    (case (handler_ ) of
     { ( _handlerIgathFviMp,_handlerIhasSideEffect,_handlerInmAlias,_handlerItrf) ->
         (case (body_ ) of
          { ( _bodyIgathFviMp,_bodyIhasSideEffect,_bodyInmAlias,_bodyItrf) ->
                      ...
                      (case (False) of
                       ...
                       (case (case (_bodyInmAlias,_exprIhasSideEffect) of
                        ...
                        (case (GrExpr_Seq _exprItrf _patItrf _bodyItrf) of
                         { _trf ->
                         (case (case (_patInmAlias, _trf, _bodyItrf) of
                                  (NmAlias_Nm n1,GrExpr_Seq e (GrPatLam_Var p) b,_) | grExprIsElimable e && not (n1 `Map.member` _bodyIgathFviMp)
                                    -> b
                                  _ -> _trf) of
                          { _lhsOtrf ->
                          ( _lhsOgathFviMp,_lhsOhasSideEffect,_lhsOnmAlias,_lhsOtrf) }) }) }) }) }) }) }) }) }) })
     ...
     (case ([]) of
      ...
      (case (NmAlias_None) of
       ...
       (case (GrPatAlt_LitInt int_) of
        ...
        (case (_trf) of
         { _lhsOtrf ->
         ( _lhsOgathFviMp,_lhsOintroNmL,_lhsOnmAlias,_lhsOtrf) }) }) }) }) })
         ...
         (case (_offIgathFviMp) of
          ...
          (case ([nm_]) of
           ...
           (case (GrSplit_Sel nm_ _offItrf) of
            ...
            (case (_trf) of
             { _lhsOtrf ->
             ( _lhsOgathFviMp,_lhsOintroNmL,_lhsOtrf) }) }) }) }) })
-- GrSplitL ----------------------------------------------------
{-
   visit 0:
      synthesized attributes:
...
-- semantic domain
type T_GrVal  = ( FvInfoMp,NmAlias,GrVal )
...
sem_GrVal_Node tag_ fldL_  =
    (case (fldL_ ) of
     { ( _fldLIgathFviMp,_fldLInmAliasL,_fldLItrf) ->
         (case (tag_ ) of
          { ( _tagIgathFviMp,_tagItrf) ->
              (case (_tagIgathFviMp `fviMpUnion` _fldLIgathFviMp) of
               { _lhsOgathFviMp ->
...
-- semantic domain
type T_GrValL  = ( FvInfoMp,([NmAlias]),GrValL )
sem_GrValL_Cons :: T_GrVal  ->
                   T_GrValL  ->
                   T_GrValL 
sem_GrValL_Cons hd_ tl_  =
    (case (tl_ ) of
     { ( _tlIgathFviMp,_tlInmAliasL,_tlItrf) ->
         (case (hd_ ) of
          { ( _hdIgathFviMp,_hdInmAlias,_hdItrf) ->
              (case (_hdIgathFviMp `fviMpUnion` _tlIgathFviMp) of
               { _lhsOgathFviMp ->
               (case (_hdInmAlias : _tlInmAliasL) of
                ...
                (case ((:) _hdItrf _tlItrf) of
                 ...
                 (case (_trf) of
                  { _lhsOtrf ->
                  ( _lhsOgathFviMp,_lhsOnmAliasL,_lhsOtrf) }) }) }) }) }) })
