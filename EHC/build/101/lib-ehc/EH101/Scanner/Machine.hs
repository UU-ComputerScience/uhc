...
{-# LINE 37 "src/ehc/Scanner/Machine.chs" #-}
data ScanState
  = ScanState
      { ssAfterQual		:: Bool
      }
...
{-# LINE 50 "src/ehc/Scanner/Machine.chs" #-}
...
{-# LINE 58 "src/ehc/Scanner/Machine.chs" #-}
...
{-# LINE 117 "src/ehc/Scanner/Machine.chs" #-}
...
{-# LINE 137 "src/ehc/Scanner/Machine.chs" #-}
...
{-# LINE 363 "src/ehc/Scanner/Machine.chs" #-}
...
{-# LINE 445 "src/ehc/Scanner/Machine.chs" #-}
...
{-# LINE 483 "src/ehc/Scanner/Machine.chs" #-}
