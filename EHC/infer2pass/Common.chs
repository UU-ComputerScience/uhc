%%[1 hs import(Data.List) export(UID(..),uidStart,TyVarId,TyVarIdL)
%%]

%%[3 hs import(UU.Pretty) export(Err,ErrL)
%%]

%%[3 hs export(FIMode(..),fioIsMeetJoin,fioIsSubsume,fimOpp)
%%]

%%[3 hs export(CoContraVariance(..),cocoOpp)
%%]

%%[3 hs export(FIOpts(..),strongFIOpts,joinFIOpts,meetFIOpts,fioSwapOpts,fioSwapCoCo)
%%]
