...
INF2PS_RL_RULES_SRC_CRUL				:= $(addprefix $(INF2PS_SRC_PREFIX),$(INF2PS_RL_RULES_BASE).crul)
INF2PS_RL_RULES_DRV_RUL					:= $(patsubst $(INF2PS_SRC_PREFIX)%.crul,$(INF2PS_BLD_VARIANT_PREFIX)%.rul,$(INF2PS_RL_RULES_SRC_CRUL))
...
INF2PS_HS_DPDS_SRC_CHS					:= $(patsubst %,$(INF2PS_SRC_PREFIX)%.chs,Infer2PassSupport Common Cnstr Substitutable)
...
INF2PS_AGTY_MAIN_SRC_CAG				:= $(patsubst %,$(INF2PS_SRC_PREFIX)%.cag,Ty)
INF2PS_AGTY_DPDS_SRC_CAG				:= $(patsubst %,$(INF2PS_SRC_PREFIX)%.cag,TyAbsSyn)
$(patsubst $(INF2PS_SRC_PREFIX)%.cag,$(INF2PS_BLD_VARIANT_PREFIX)%.hs,$(INF2PS_AGTY_MAIN_SRC_CAG)) \
										: $(patsubst $(INF2PS_SRC_PREFIX)%.cag,$(INF2PS_BLD_VARIANT_PREFIX)%.ag,$(INF2PS_AGTY_DPDS_SRC_CAG))

INF2PS_AGTY_ELIMALT_MAIN_SRC_CAG		:= $(patsubst %,$(INF2PS_SRC_PREFIX)%.cag,TyElimAlts)
INF2PS_AGTY_ELIMALT_DPDS_SRC_CAG		:= $(patsubst %,$(INF2PS_SRC_PREFIX)%.cag,TyAbsSyn)
$(patsubst $(INF2PS_SRC_PREFIX)%.cag,$(INF2PS_BLD_VARIANT_PREFIX)%.hs,$(INF2PS_AGTY_ELIMALT_MAIN_SRC_CAG)) \
										: $(patsubst $(INF2PS_SRC_PREFIX)%.cag,$(INF2PS_BLD_VARIANT_PREFIX)%.ag,$(INF2PS_AGTY_ELIMALT_DPDS_SRC_CAG))

INF2PS_AGTY_SUBST_MAIN_SRC_CAG			:= $(patsubst %,$(INF2PS_SRC_PREFIX)%.cag,TyElimBoth)
INF2PS_AGTY_SUBST_DPDS_SRC_CAG			:= $(patsubst %,$(INF2PS_SRC_PREFIX)%.cag,TyAbsSyn)
$(patsubst $(INF2PS_SRC_PREFIX)%.cag,$(INF2PS_BLD_VARIANT_PREFIX)%.hs,$(INF2PS_AGTY_SUBST_MAIN_SRC_CAG)) \
										: $(patsubst $(INF2PS_SRC_PREFIX)%.cag,$(INF2PS_BLD_VARIANT_PREFIX)%.ag,$(INF2PS_AGTY_SUBST_DPDS_SRC_CAG))

INF2PS_AGTY_FTV_MAIN_SRC_CAG			:= $(patsubst %,$(INF2PS_SRC_PREFIX)%.cag,TySubst)
INF2PS_AGTY_FTV_DPDS_SRC_CAG			:= $(patsubst %,$(INF2PS_SRC_PREFIX)%.cag,TyAbsSyn)
$(patsubst $(INF2PS_SRC_PREFIX)%.cag,$(INF2PS_BLD_VARIANT_PREFIX)%.hs,$(INF2PS_AGTY_FTV_MAIN_SRC_CAG)) \
										: $(patsubst $(INF2PS_SRC_PREFIX)%.cag,$(INF2PS_BLD_VARIANT_PREFIX)%.ag,$(INF2PS_AGTY_FTV_DPDS_SRC_CAG))

INF2PS_AGTY_ELIMBOTH_MAIN_SRC_CAG		:= $(patsubst %,$(INF2PS_SRC_PREFIX)%.cag,TyFtv)
INF2PS_AGTY_ELIMBOTH_DPDS_SRC_CAG		:= $(patsubst %,$(INF2PS_SRC_PREFIX)%.cag,TyAbsSyn)
$(patsubst $(INF2PS_SRC_PREFIX)%.cag,$(INF2PS_BLD_VARIANT_PREFIX)%.hs,$(INF2PS_AGTY_ELIMBOTH_MAIN_SRC_CAG)) \
										: $(patsubst $(INF2PS_SRC_PREFIX)%.cag,$(INF2PS_BLD_VARIANT_PREFIX)%.ag,$(INF2PS_AGTY_ELIMBOTH_DPDS_SRC_CAG))
...
INF2PS_AG_D_MAIN_DRV_AG					:= $(patsubst $(INF2PS_SRC_PREFIX)%.cag,$(INF2PS_BLD_VARIANT_PREFIX)%.ag,$(INF2PS_AG_D_MAIN_SRC_CAG))
INF2PS_AG_S_MAIN_DRV_AG					:= $(patsubst $(INF2PS_SRC_PREFIX)%.cag,$(INF2PS_BLD_VARIANT_PREFIX)%.ag,$(INF2PS_AG_S_MAIN_SRC_CAG))
...
INF2PS_AG_ALL_DPDS_DRV_AG				:= $(patsubst $(INF2PS_SRC_PREFIX)%.cag,$(INF2PS_BLD_VARIANT_PREFIX)%.ag,$(INF2PS_AG_ALL_DPDS_SRC_CAG))
...
$(INF2PS_AG_D_MAIN_DRV_HS): $(INF2PS_BLD_VARIANT_PREFIX)%.hs: $(INF2PS_BLD_VARIANT_PREFIX)%.ag
	mkdir -p $(@D) ; \
	$(AGC) -dr -P"$(INF2PS_SRC_PREFIX)" -P"$(INF2PS_BLD_VARIANT_PREFIX)" -o $@ $<
...
$(INF2PS_RL_RULES_DRV_RUL): $(INF2PS_BLD_VARIANT_PREFIX)%.rul: $(INF2PS_SRC_PREFIX)%.crul $(SHUFFLE)
	mkdir -p $(@D)
