...
RULER2_DEMO_CAG_MAIN_SRC	:= $(RULER2_DEMO_PREFIX)$(RULER2_DEMO_AG_MAIN).cag
...
RULER2_DEMO_AG_MAIN_DRV		:= $(RULER2_DEMO_CAG_MAIN_SRC:.cag=.ag)
RULER2_DEMO_AG_MAIN_DRV_TEX	:= $(RULER2_DEMO_CAG_MAIN_SRC:.cag=.tex)
RULER2_DEMO_HS_DRV			:= $(RULER2_DEMO_AG_MAIN_DRV:.ag=.hs)
...
$(RULER2_DEMO_AG_MAIN_DRV): $(RULER2_DEMO_CAG_MAIN_SRC) $(SHUFFLE)
	$(SHUFFLE) --gen=$(RULER2_DEMO_SHUFFLE_FINAL) --ag --order="$(RULER2_DEMO_SHUFFLE_ORDER)" --base=Main --prefix=no --lhs2tex=no $< > $@

$(RULER2_DEMO_AG_MAIN_DRV_TEX): $(RULER2_DEMO_CAG_MAIN_SRC) $(SHUFFLE)
