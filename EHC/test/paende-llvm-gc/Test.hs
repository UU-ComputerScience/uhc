...
main =  sum $ lcss [ 1 , 2 .. 2000 ] [1000,1001..3000]
-- This prelude can be compiled by EHC 11, and contains:
-- from Prelude8.hs:
...
-- and additional:
-- * type synonyms for String and ShowS
-- * primitives for Char
-- * utilities for Char and String
-- * class Show, and its instances Int, Char, List
...
-- Int instance of Eq, Ord, Integral, Num, Bounded, Enum, Show
...
-- Char instance of Eq, Ord, Enum, Bounded, Show
